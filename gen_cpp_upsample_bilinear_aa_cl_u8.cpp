                       ...
                       unsigned char* out_ptr10)
{
    ...
    // COMPUTE PREP H WEIGHTS
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(272L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp5 = decltype(tmp3)(tmp3 * tmp4);  // center = scale * (i + 0.5)
            auto tmp6 = tmp5 + tmp4;
            auto tmp7 = tmp6 + tmp2;
            ...
            auto tmp15 = max_propagate_nan(tmp13, tmp14);  // xmin
            auto tmp16 = tmp10 - tmp15;
            auto tmp17 = static_cast<long>(5);
            auto tmp18 = min_propagate_nan(tmp16, tmp17);  // xsize
            ...
            out_ptr0[static_cast<long>(x0)] = tmp79;  // slice of horiz weights
        }
    }

    // COMPUTE PREP V WEIGHTS
    {
        #pragma GCC ivdep
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(3L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(345L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(272L); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp23 = out_ptr2[static_cast<long>(272L + x2)];
                    auto tmp31 = out_ptr2[static_cast<long>(544L + x2)];
                    auto tmp39 = out_ptr2[static_cast<long>(816L + x2)];
                    ...
                    in_out_ptr0[static_cast<long>(x2 + (272L*x1) + (93840L*x0))] = tmp41;
                }
            }
        }
    }
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(3L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(271L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(272L); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp66 = out_ptr4[static_cast<long>(271L + x1)];
                    auto tmp69 = out_ptr4[static_cast<long>(542L + x1)];
                    auto tmp72 = out_ptr4[static_cast<long>(813L + x1)];
                    auto tmp75 = out_ptr4[static_cast<long>(1084L + x1)];
                    auto tmp0 = static_cast<long>(x1);
                    auto tmp1 = static_cast<float>(tmp0);
                    auto tmp2 = static_cast<float>(0.5);
                    auto tmp3 = tmp1 + tmp2;
                    ...
                    auto tmp36 = in_out_ptr0[static_cast<long>(x2 + (272L*tmp35) + (93840L*x0))];
                    ...
                    auto tmp44 = in_out_ptr0[static_cast<long>(x2 + (272L*tmp43) + (93840L*x0))];
                    ...
                    auto tmp52 = in_out_ptr0[static_cast<long>(x2 + (272L*tmp51) + (93840L*x0))];
                    ...
                    auto tmp59 = in_out_ptr0[static_cast<long>(x2 + (272L*tmp58) + (93840L*x0))];
                    ...
                    in_out_ptr1[static_cast<long>(x2 + (272L*x1) + (73712L*x0))] = tmp77;
                }
            }
        }
    }
