...
# kernel path: /tmp/torchinductor_root/rt/crt6ld3sxosr625mg6356ykn7p5cc5vbct5lbhviekyferukjwa6.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg1_1
        buf62 = empty_strided((2, 3, 345, 456), (471960, 1, 1368, 3), device='cuda', dtype=torch.float32)
        # Source Nodes: [grid_sample], Original ATen: [aten.grid_sampler_2d]
        triton_poi_fused_grid_sampler_2d_1.run(buf1, arg0_1, buf62, 6, 157320, grid=grid(6, 157320), stream=stream0)
        del arg0_1
        return (buf62, )
