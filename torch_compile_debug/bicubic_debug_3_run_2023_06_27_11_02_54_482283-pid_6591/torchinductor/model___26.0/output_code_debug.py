...
{
    {
        ...
        for(long i0=static_cast<long>(0L); i0<static_cast<long>(3L); i0+=static_cast<long>(1L))
        {
            ...
            for(long i1=static_cast<long>(0L); i1<static_cast<long>(12L); i1+=static_cast<long>(1L))
            {
                ...
                {
                    auto tmp0 = static_cast<float>(1.00000000000000*i2);
                    ...
                    // std::cout << "tmp72, tmp61, tmp34: " << " "<< tmp72 << " "<< tmp61 << " "<< tmp34 << std::endl;
                    assert(tmp72 == 0.0);
                    ...
                    if (i0 == 0 && i2 == 0) {
                        std::cout << "tmp121, tmp126, tmp132, tmp139: "
                                << tmp121 << " "
                                << tmp126 << " "
                                << tmp132 << " "
                                << tmp139 << " "
