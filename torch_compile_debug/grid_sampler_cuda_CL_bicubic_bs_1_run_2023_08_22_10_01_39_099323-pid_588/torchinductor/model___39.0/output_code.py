...
# kernel path: /tmp/torchinductor_root/gb/cgb546mxwlwsgbhiw4prvthtp2wioynbbdouyjlzcgxzirshiv6a.py
...
@pointwise(size_hints=[524288], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'mutated_arg_names': ['in_out_ptr8'], 'autotune_hints': set(), 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
def triton_(in_out_ptr8, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp31 = tl.load(in_ptr1 + (x1 + (3*tmp30) + (1368*tmp28)), xmask)
    ...
    tmp44 = tl.load(in_ptr1 + (x1 + (3*tmp43) + (1368*tmp41)), xmask)
    ...
    tmp57 = tl.load(in_ptr1 + (x1 + (3*tmp56) + (1368*tmp54)), xmask)
    ...
    tmp70 = tl.load(in_ptr1 + (x1 + (3*tmp69) + (1368*tmp68)), xmask)
    ...
    tmp78 = tl.load(in_ptr1 + (x1 + (3*tmp77) + (1368*tmp76)), xmask)
    ...
    tmp86 = tl.load(in_ptr1 + (x1 + (3*tmp85) + (1368*tmp84)), xmask)
    ...
    tmp99 = tl.load(in_ptr1 + (x1 + (3*tmp98) + (1368*tmp97)), xmask)
    ...
    tmp107 = tl.load(in_ptr1 + (x1 + (3*tmp106) + (1368*tmp105)), xmask)
    ...
    tmp115 = tl.load(in_ptr1 + (x1 + (3*tmp114) + (1368*tmp113)), xmask)
    ...
    tmp128 = tl.load(in_ptr1 + (x1 + (3*tmp127) + (1368*tmp126)), xmask)
    ...
    tmp136 = tl.load(in_ptr1 + (x1 + (3*tmp135) + (1368*tmp134)), xmask)
    ...
    tmp144 = tl.load(in_ptr1 + (x1 + (3*tmp143) + (1368*tmp142)), xmask)
    ...
    tmp155 = tl.load(in_ptr1 + (x1 + (3*tmp154) + (1368*tmp152)), xmask)
    ...
    tmp172 = tl.load(in_ptr1 + (x1 + (3*tmp171) + (1368*tmp170)), xmask)
    ...
    tmp181 = tl.load(in_ptr1 + (x1 + (3*tmp180) + (1368*tmp179)), xmask)
    ...
    tmp190 = tl.load(in_ptr1 + (x1 + (3*tmp189) + (1368*tmp188)), xmask)
    ...
    tl.store(in_out_ptr8 + (x2), tmp275, xmask)
''')
