...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1):
        iota = torch.ops.prims.iota.default(3456, start = 0, step = 1, dtype = torch.int32, device = device(type='cuda', index=0), requires_grad = False)
        add = torch.ops.aten.add.Tensor(iota, 0.5);  iota = None
        mul = torch.ops.aten.mul.Tensor(add, 1.3214699074074074);  add = None
        sub = torch.ops.aten.sub.Tensor(mul, 1.3214699074074074)
        ...
        add_2 = torch.ops.aten.add.Tensor(mul, 1.3214699074074074)
        ...
        clamp_max = torch.ops.aten.clamp_max.default(convert_element_type_1, 4567);  convert_element_type_1 = None
        ...
        mul_1 = torch.ops.aten.mul.Tensor(add_5, 0.7567330851762645);  add_5 = None
        ...
        iota_2 = torch.ops.prims.iota.default(2345, start = 0, step = 1, dtype = torch.int32, device = device(type='cuda', index=0), requires_grad = False)
        add_6 = torch.ops.aten.add.Tensor(iota_2, 0.5);  iota_2 = None
        mul_2 = torch.ops.aten.mul.Tensor(add_6, 1.473773987206823);  add_6 = None
        sub_4 = torch.ops.aten.sub.Tensor(mul_2, 1.473773987206823)
        ...
        add_8 = torch.ops.aten.add.Tensor(mul_2, 1.473773987206823)
        ...
        clamp_max_3 = torch.ops.aten.clamp_max.default(convert_element_type_3, 3456);  convert_element_type_3 = None
        ...
        mul_3 = torch.ops.aten.mul.Tensor(add_11, 0.6785300925925927);  add_11 = None
        ...
        clamp_max_6 = torch.ops.aten.clamp_max.default(add_12, 4566);  add_12 = None
        add_13 = torch.ops.aten.add.Tensor(unsqueeze_3, iota_5);  unsqueeze_3 = iota_5 = None
        clamp_max_7 = torch.ops.aten.clamp_max.default(add_13, 3455);  add_13 = None
        view_8 = torch.ops.aten.view.default(clamp_max_7, [2345, 5, 1, 1]);  clamp_max_7 = None
        ...
        view_9 = torch.ops.aten.view.default(div_1, [2345, 5, 1, 1]);  div_1 = None
        view_10 = torch.ops.aten.view.default(div, [1, 3456, 5]);  div = None
...
def load_args(reader):
    buf0 = reader.storage(None, 189402624, device=device(type='cuda', index=0))
    reader.tensor(buf0, (1, 3, 3456, 4567), is_leaf=True)  # arg0_1
