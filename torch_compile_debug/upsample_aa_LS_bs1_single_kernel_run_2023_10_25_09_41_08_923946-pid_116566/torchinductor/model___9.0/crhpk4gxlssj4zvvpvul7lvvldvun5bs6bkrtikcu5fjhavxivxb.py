...
# kernel path: /tmp/torchinductor_root/fr/cfrnq44pfd57qjuzqmxlqhtoovdulih5vuehli6adgjflk6zhksc.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_index_mul_sum_0.run(arg0_1, buf6, 97251840, 25, grid=grid(97251840), stream=stream0)
        del arg0_1
        return (buf6, )
