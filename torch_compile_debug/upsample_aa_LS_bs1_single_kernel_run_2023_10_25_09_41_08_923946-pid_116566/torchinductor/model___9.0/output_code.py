...
def call(args):
    arg0_1, = args
    args.clear()
    assert_size_stride(arg0_1, (1, 3, 3456, 4567), (47350656, 15783552, 4567, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0) # no-op to ensure context
        buf6 = empty((1, 3, 2345, 3456), device='cuda', dtype=torch.float32)
        # Source Nodes: [img], Original ATen: [aten.index, aten.mul, aten.sum]
        stream0 = get_cuda_stream(0)
        triton_per_fused_index_mul_sum_0.run(arg0_1, buf6, 24312960, 25, grid=grid(24312960), stream=stream0)
        del arg0_1
        return (buf6, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 3, 3456, 4567), (47350656, 15783552, 4567, 1), device='cuda:0', dtype=torch.float32)
