class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[3, 345, 456]):
        ...
        unsqueeze_1: f32[224, 1] = torch.ops.aten.unsqueeze.default(clamp_min, 1)
        sub_2: f32[224, 1] = torch.ops.aten.sub.Tensor(unsqueeze_1, unsqueeze_2);  unsqueeze_1 = None
        ...
        ceil: f32[224] = torch.ops.aten.ceil.default(clamp_min);  clamp_min = None
        ...
        sub_4: f32[224] = torch.ops.aten.sub.Tensor(clamp_min_1, convert_element_type_6);  convert_element_type_6 = None
        ...
        ceil_1: f32[224] = torch.ops.aten.ceil.default(clamp_min_1);  clamp_min_1 = None
        ...
        _unsafe_index_2: f32[1, 3, 224, 224] = torch.ops.aten._unsafe_index.Tensor(unsqueeze, [None, None, unsqueeze_2, convert_element_type_7]);  unsqueeze_2 = None
