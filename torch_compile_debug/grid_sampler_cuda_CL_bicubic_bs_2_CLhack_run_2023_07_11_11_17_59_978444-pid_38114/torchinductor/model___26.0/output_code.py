...
# kernel path: /tmp/torchinductor_root/ao/caondnuzdo4a3es3q6pbi3r2kj4k6xx5ib5reqnsl3nlljd73rtc.py
...
@pointwise(size_hints=[8, 262144], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr24, xnumel, ynumel, XBLOCK : tl.constexpr, YBLOCK : tl.constexpr):
    xnumel = 6
    ynumel = 157320
    xoffset = tl.program_id(0) * XBLOCK
    ...
    x3 = xindex
    x0 = xindex % 3
    tmp0 = tl.load(in_ptr0 + ((2*y2) + (314640*x1)), xmask & ymask, eviction_policy='evict_last')
    tmp12 = tl.load(in_ptr0 + (1 + (2*y2) + (314640*x1)), xmask & ymask, eviction_policy='evict_last')
    tmp1 = 228.0
    tmp2 = tmp0 * tmp1
    tmp3 = 227.5
    tmp4 = tmp2 + tmp3
    ...
    tmp33 = tl.load(in_ptr1 + (x0 + (3*tmp30) + (1368*tmp28) + (471960*x1)), xmask)
    ...
    tmp48 = tl.load(in_ptr1 + (x0 + (3*tmp45) + (1368*tmp43) + (471960*x1)), xmask)
    ...
    tmp63 = tl.load(in_ptr1 + (x0 + (3*tmp60) + (1368*tmp58) + (471960*x1)), xmask)
    ...
    tmp78 = tl.load(in_ptr1 + (x0 + (3*tmp75) + (1368*tmp74) + (471960*x1)), xmask)
    ...
    tmp88 = tl.load(in_ptr1 + (x0 + (3*tmp85) + (1368*tmp84) + (471960*x1)), xmask)
    ...
    tmp98 = tl.load(in_ptr1 + (x0 + (3*tmp95) + (1368*tmp94) + (471960*x1)), xmask)
    ...
    tmp113 = tl.load(in_ptr1 + (x0 + (3*tmp110) + (1368*tmp109) + (471960*x1)), xmask)
    ...
    tmp123 = tl.load(in_ptr1 + (x0 + (3*tmp120) + (1368*tmp119) + (471960*x1)), xmask)
    ...
    tmp133 = tl.load(in_ptr1 + (x0 + (3*tmp130) + (1368*tmp129) + (471960*x1)), xmask)
    ...
    tmp148 = tl.load(in_ptr1 + (x0 + (3*tmp145) + (1368*tmp144) + (471960*x1)), xmask)
    ...
    tmp158 = tl.load(in_ptr1 + (x0 + (3*tmp155) + (1368*tmp154) + (471960*x1)), xmask)
    ...
    tmp168 = tl.load(in_ptr1 + (x0 + (3*tmp165) + (1368*tmp164) + (471960*x1)), xmask)
    ...
    tmp220 = tl.load(in_ptr1 + (x0 + (3*tmp218) + (1368*tmp215) + (471960*x1)), xmask)
    ...
    tmp236 = tl.load(in_ptr1 + (x0 + (3*tmp234) + (1368*tmp232) + (471960*x1)), xmask)
    ...
    tmp247 = tl.load(in_ptr1 + (x0 + (3*tmp245) + (1368*tmp243) + (471960*x1)), xmask)
    ...
    tmp258 = tl.load(in_ptr1 + (x0 + (3*tmp256) + (1368*tmp254) + (471960*x1)), xmask)
    ...
    tl.store(out_ptr24 + (x0 + (3*y2) + (471960*x1)), tmp307, xmask & ymask)
''')
