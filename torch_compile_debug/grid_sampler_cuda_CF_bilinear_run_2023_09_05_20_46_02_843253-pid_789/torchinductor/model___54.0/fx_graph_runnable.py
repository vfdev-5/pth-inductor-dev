...
# torch version: 2.1.0a0+git31ef338
# torch cuda version: 12.1
# torch git version: 31ef33871d2890adf78c02a8188e206089e26d3f
...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1):
        ...
        view_4 = torch.ops.aten.view.default(view_3, [8, 1, 345, 456, 2]);  view_3 = None
        expand = torch.ops.aten.expand.default(view_4, [8, 3, 345, 456, 2]);  view_4 = None
        ...
        view_5 = torch.ops.aten.view.default(iota_2, [8, 1, 1, 1]);  iota_2 = None
...
def load_args(reader):
    buf0 = reader.storage(None, 15102720, device=device(type='cuda', index=0))
    reader.tensor(buf0, (8, 3, 345, 456), is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 192, device=device(type='cuda', index=0))
