...
# kernel path: /tmp/torchinductor_root/y7/cy7saxoo2mf2lgmw6pq7fyepxqmzf3ix4vf54cf4vygeaf4yxrt4.py
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_affine_grid_generator_0', 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(2,))]})
@triton.jit
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_grid_sampler_2d_1', 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(3,))]})
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp10 = tl.load(in_ptr0 + (1 + (2*x0) + (314640*x2)), xmask, eviction_policy='evict_last')
    tmp1 = 228.0
    tmp2 = tmp0 * tmp1
    tmp3 = 227.5
    tmp4 = tmp2 + tmp3
    ...
    tmp42 = tl.where(tmp41 < 0, tmp41 + 345, tmp41)
    ...
    tmp45 = tl.where(tmp44 < 0, tmp44 + 456, tmp44)
    tl.device_assert((0 <= tmp45) & (tmp45 < 456), "index out of bounds: 0 <= tmp45 < 456")
    tmp46 = tl.load(in_ptr1 + (tmp45 + (456*tmp42) + (157320*x3)), xmask)
    tmp47 = tmp4 - tmp5
    tmp48 = tmp47 * tmp34
    ...
    tmp73 = tmp60 * tmp63
    tmp74 = tmp72 + tmp73
    tmp75 = tl.where(tmp68 < 0, tmp68 + 345, tmp68)
    tl.device_assert((0 <= tmp75) & (tmp75 < 345), "index out of bounds: 0 <= tmp75 < 345")
    tmp76 = tl.where(tmp69 < 0, tmp69 + 456, tmp69)
    tl.device_assert((0 <= tmp76) & (tmp76 < 456), "index out of bounds: 0 <= tmp76 < 456")
    tmp77 = tl.load(in_ptr1 + (tmp76 + (456*tmp75) + (157320*x3)), xmask)
    tmp78 = tmp77 * tmp67
    tmp79 = tmp74 + tmp78
    tl.store(in_out_ptr0 + (x4), tmp79, xmask)
''')
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf1 = empty_strided((8, 157320, 2), (314640, 2, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [affine_grid], Original ATen: [aten.affine_grid_generator]
        stream0 = get_cuda_stream(0)
        triton_poi_fused_affine_grid_generator_0.run(arg1_1, buf1, 2517120, grid=grid(2517120), stream=stream0)
        del arg1_1
        buf10 = empty_strided((8, 3, 345, 456), (471960, 157320, 456, 1), device='cuda', dtype=torch.float32)
        buf11 = buf10; del buf10  # reuse
        # Source Nodes: [grid_sample], Original ATen: [aten.grid_sampler_2d]
        triton_poi_fused_grid_sampler_2d_1.run(buf11, buf1, arg0_1, 3775680, grid=grid(3775680), stream=stream0)
        del arg0_1
        return (buf11, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((8, 3, 345, 456), (471960, 157320, 456, 1), device='cuda:0', dtype=torch.float32)
    arg1_1 = rand_strided((8, 2, 3), (6, 3, 1), device='cuda:0', dtype=torch.float32)
