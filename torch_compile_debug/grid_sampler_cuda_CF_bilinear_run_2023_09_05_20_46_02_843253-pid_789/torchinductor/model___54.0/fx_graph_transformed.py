class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[8, 3, 345, 456], arg1_1: f32[8, 2, 3]):
        ...
        view_5: i64[8, 1, 1, 1] = torch.ops.aten.reshape.default(iota_2, [8, 1, 1, 1]);  iota_2 = None
        ...
        # File: check_affine_grid_sampler.py:25, code: output = grid_sample(img, grid, align_corners=align_corners, mode=mode)
        view_4: f32[8, 1, 345, 456, 2] = torch.ops.aten.reshape.default(view_3, [8, 1, 345, 456, 2]);  view_3 = None
        ...
        convert_element_type_7: i64[8, 3, 345, 456] = torch.ops.prims.convert_element_type.default(floor_1, torch.int64)
        ...
        convert_element_type_8: i64[8, 3, 345, 456] = torch.ops.prims.convert_element_type.default(floor, torch.int64)
        ...
        sub_10: f32[8, 3, 345, 456] = torch.ops.aten.sub.Tensor(add_4, floor);  add_4 = floor = None
        sub_11: f32[8, 3, 345, 456] = torch.ops.aten.sub.Tensor(add_5, floor_1);  add_5 = floor_1 = None
