                       ...
                       unsigned char* out_ptr10)
{
    ...
    {
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(874800L); x0+=static_cast<long>(8L))
        {
...
def call(args):
    ...
    buf5 = empty_strided((4, 3, 345, 270), (279450, 93150, 270, 1), device='cpu', dtype=torch.float32)
    buf6 = buf5; del buf5  # reuse
    buf7 = empty_strided((4, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf9 = empty_strided((4, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf10 = empty_strided((4, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf11 = empty_strided((4, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf12 = empty_strided((4, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf8 = empty_strided((5, 270), (270, 1), device='cpu', dtype=torch.float32)
    buf13 = buf10; del buf10  # reuse
    buf14 = empty_strided((4, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.uint8)
    cpp_fused__to_copy_add_div_index_mul_round_sum_unbind_0(c_void_p(buf6.data_ptr()), c_void_p(buf13.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf7.data_ptr()), c_void_p(buf9.data_ptr()), c_void_p(buf11.data_ptr()), c_void_p(buf12.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf14.data_ptr()))
    del arg0_1
    return (buf14, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((4, 3, 345, 456), (471960, 1, 1368, 3), device='cpu', dtype=torch.uint8)
