...
def call(args):
    ...
    buf10 = empty_strided((1, 3, 271, 272), (221136, 73712, 272, 1), device='cpu', dtype=torch.float32)
    buf13 = buf10; del buf10  # reuse
    buf14 = empty_strided((1, 3, 271, 272), (221136, 1, 816, 3), device='cpu', dtype=torch.uint8)
