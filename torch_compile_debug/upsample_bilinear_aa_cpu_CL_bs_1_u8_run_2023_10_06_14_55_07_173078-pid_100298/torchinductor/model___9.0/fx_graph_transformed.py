class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: u8[1, 3, 345, 456]):
        ...
        index: u8[1, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [full_default, view_1, view_3, clamp_max_3]);  clamp_max_3 = None
        mul_2: f32[1, 3, 345, 272] = torch.ops.aten.mul.Tensor(index, getitem);  index = getitem = None
        ...
        index_1: u8[1, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [full_default, view_1, view_3, clamp_max_4]);  clamp_max_4 = None
        mul_3: f32[1, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_1, getitem_1);  index_1 = getitem_1 = None
        ...
        index_2: u8[1, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [full_default, view_1, view_3, clamp_max_5]);  clamp_max_5 = None
        mul_4: f32[1, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_2, getitem_2);  index_2 = getitem_2 = None
        ...
        index_3: u8[1, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [full_default, view_1, view_3, clamp_max_6]);  clamp_max_6 = None
        mul_5: f32[1, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_3, getitem_3);  index_3 = getitem_3 = None
        ...
        index_4: u8[1, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [full_default, view_1, view_3, clamp_max_7]);  arg0_1 = full_default = view_1 = view_3 = clamp_max_7 = None
        ...
        mul_6: f32[1, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_4, full_default_2);  index_4 = full_default_2 = None
        ...
        mul_9: f32[1, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_5, getitem_5);  index_5 = getitem_5 = None
        ...
        mul_10: f32[1, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_6, getitem_6);  index_6 = getitem_6 = None
        ...
        mul_11: f32[1, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_7, getitem_7);  index_7 = getitem_7 = None
        ...
        mul_12: f32[1, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_8, getitem_8);  index_8 = getitem_8 = None
        ...
        mul_13: f32[1, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_9, getitem_9);  index_9 = getitem_9 = None
        add_29: f32[1, 3, 271, 272] = torch.ops.aten.add.Tensor(add_28, mul_13);  add_28 = mul_13 = None
        round_1: f32[1, 3, 271, 272] = torch.ops.aten.round.default(add_29);  add_29 = None
        clone: f32[1, 3, 271, 272] = torch.ops.aten.clone.default(round_1, memory_format = torch.channels_last);  round_1 = None
        convert_element_type_4: u8[1, 3, 271, 272] = torch.ops.prims.convert_element_type.default(clone, torch.uint8);  clone = None
