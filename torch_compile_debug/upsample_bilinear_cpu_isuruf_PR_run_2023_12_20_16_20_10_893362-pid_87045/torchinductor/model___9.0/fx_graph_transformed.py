class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "Sym(s0)", arg1_1: "Sym(s1)", arg2_1: "Sym(s2)", arg3_1: "f32[1, s0, s1, s2]", arg4_1: "Sym(1234)", arg5_1: "Sym(1345)"):
        ...
        view: "f32[1234, 1]" = torch.ops.aten.reshape.default(clamp_min, [1234, 1]);  clamp_min = None
        ...
        _unsafe_index_3: "f32[1, s0, 1234, 1345]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, where, where_1])
        _unsafe_index_2: "f32[1, s0, 1234, 1345]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, where, convert_element_type_3]);  where = None
        sub_6: "f32[1, s0, 1234, 1345]" = torch.ops.aten.sub.Tensor(_unsafe_index_3, _unsafe_index_2);  _unsafe_index_3 = None
        sub_4: "f32[1345]" = torch.ops.aten.sub.Tensor(clamp_min_1, convert_element_type_3);  clamp_min_1 = None
        ...
        mul_3: "f32[1, s0, 1234, 1345]" = torch.ops.aten.mul.Tensor(sub_6, clamp_max);  sub_6 = None
        add_5: "f32[1, s0, 1234, 1345]" = torch.ops.aten.add.Tensor(_unsafe_index_2, mul_3);  _unsafe_index_2 = mul_3 = None
        _unsafe_index_1: "f32[1, s0, 1234, 1345]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, convert_element_type_1, where_1]);  where_1 = None
        _unsafe_index: "f32[1, s0, 1234, 1345]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, convert_element_type_1, convert_element_type_3]);  arg3_1 = convert_element_type_3 = None
        sub_5: "f32[1, s0, 1234, 1345]" = torch.ops.aten.sub.Tensor(_unsafe_index_1, _unsafe_index);  _unsafe_index_1 = None
        mul_2: "f32[1, s0, 1234, 1345]" = torch.ops.aten.mul.Tensor(sub_5, clamp_max);  sub_5 = clamp_max = None
