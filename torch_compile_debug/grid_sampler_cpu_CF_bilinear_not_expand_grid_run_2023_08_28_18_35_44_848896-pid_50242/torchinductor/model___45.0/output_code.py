                       ...
                       float* out_ptr6)
{
    ...
    {
        #pragma GCC ivdep
        for(long i0=static_cast<long>(0L); i0<static_cast<long>(1258560L); i0+=static_cast<long>(1L))
        {
...
def call(args):
    ...
    buf3 = empty_strided((8, 345, 456), (157320, 456, 1), device='cpu', dtype=torch.float32)
    buf5 = empty_strided((8, 345, 456), (157320, 456, 1), device='cpu', dtype=torch.float32)
    buf7 = empty_strided((8, 345, 456), (157320, 456, 1), device='cpu', dtype=torch.float32)
    buf8 = empty_strided((8, 345, 456), (157320, 456, 1), device='cpu', dtype=torch.int64)
    buf9 = empty_strided((8, 345, 456), (157320, 456, 1), device='cpu', dtype=torch.int64)
    buf10 = empty_strided((8, 345, 456), (157320, 456, 1), device='cpu', dtype=torch.float32)
