        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(2L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(3L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(345L); x2+=static_cast<long>(1L))
                {
                    ...
                    {
                        auto tmp15 = out_ptr2[static_cast<long>(x3)];
                        auto tmp21 = out_ptr2[static_cast<long>(272L + x3)];
                        auto tmp28 = out_ptr2[static_cast<long>(544L + x3)];
                        auto tmp35 = out_ptr2[static_cast<long>(816L + x3)];
                        ...
                        auto tmp20 = in_ptr0[static_cast<long>(x1 + (3L*tmp19) + (1368L*x2) + (471960L*x0))];
                        ...
                        auto tmp27 = in_ptr0[static_cast<long>(x1 + (3L*tmp26) + (1368L*x2) + (471960L*x0))];
                        ...
                        auto tmp34 = in_ptr0[static_cast<long>(x1 + (3L*tmp33) + (1368L*x2) + (471960L*x0))];
                        auto tmp36 = decltype(tmp34)(tmp34 * tmp35);
                        auto tmp37 = tmp30 + tmp36;
                        in_out_ptr0[static_cast<long>(x3 + (272L*x2) + (93840L*x1) + (281520L*x0))] = tmp37;
                    }
                }
            }
        }
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(3L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(271L); x2+=static_cast<long>(1L))
                {
                    ...
                    for(long x3=static_cast<long>(0L); x3<static_cast<long>(272L); x3+=static_cast<long>(1L))
                    {
                        ...
                        auto tmp13 = min_propagate_nan(tmp11, tmp12);
                        auto tmp14 = in_out_ptr0[static_cast<long>(x3 + (272L*tmp13) + (93840L*x1) + (281520L*x0))];
                        ...
                        auto tmp35 = in_out_ptr0[static_cast<long>(x3 + (272L*tmp34) + (93840L*x1) + (281520L*x0))];
                        auto tmp36 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp34) + (471960L*x0))];
                        ...
                        auto tmp42 = in_out_ptr0[static_cast<long>(x3 + (272L*tmp41) + (93840L*x1) + (281520L*x0))];
                        auto tmp43 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp41) + (471960L*x0))];
                        ...
                        auto tmp49 = in_out_ptr0[static_cast<long>(x3 + (272L*tmp48) + (93840L*x1) + (281520L*x0))];
                        auto tmp50 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp48) + (471960L*x0))];
                        ...
                        auto tmp55 = in_out_ptr0[static_cast<long>(x3 + (272L*tmp54) + (93840L*x1) + (281520L*x0))];
                        auto tmp56 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp54) + (471960L*x0))];
                        auto tmp57 = decltype(tmp56)(tmp56 * tmp29);
                        auto tmp58 = tmp55 + tmp57;
                        out_ptr4[static_cast<long>(x3 + (272L*x2) + (73712L*x1) + (221136L*x0))] = tmp31;
                        out_ptr5[static_cast<long>(x3 + (272L*x2) + (73712L*x1) + (221136L*x0))] = tmp38;
                        out_ptr6[static_cast<long>(x3 + (272L*x2) + (73712L*x1) + (221136L*x0))] = tmp45;
                        out_ptr7[static_cast<long>(x3 + (272L*x2) + (73712L*x1) + (221136L*x0))] = tmp52;
                        out_ptr8[static_cast<long>(x3 + (272L*x2) + (73712L*x1) + (221136L*x0))] = tmp58;
                    }
                }
            }
        }
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(5L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(271L); x1+=static_cast<long>(1L))
            {
                ...
                auto tmp32 = tmp20 ? tmp30 : tmp31;
                auto tmp34 = tmp32 / tmp33;
                out_ptr9[static_cast<long>(x1 + (271L*x0))] = tmp34;
            }
        }
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(6L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(271L); x1+=static_cast<long>(1L))
            {
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(272L); x2+=static_cast<long>(8L))
                {
                    auto tmp0 = at::vec::Vectorized<float>::loadu(out_ptr4 + static_cast<long>(x2 + (272L*x1) + (73712L*x0)));
                    auto tmp1 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(x1)]));
                    auto tmp3 = at::vec::Vectorized<float>::loadu(out_ptr5 + static_cast<long>(x2 + (272L*x1) + (73712L*x0)));
                    auto tmp4 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(271L + x1)]));
                    auto tmp7 = at::vec::Vectorized<float>::loadu(out_ptr6 + static_cast<long>(x2 + (272L*x1) + (73712L*x0)));
                    auto tmp8 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(542L + x1)]));
                    auto tmp11 = at::vec::Vectorized<float>::loadu(out_ptr7 + static_cast<long>(x2 + (272L*x1) + (73712L*x0)));
                    auto tmp12 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(813L + x1)]));
                    auto tmp15 = at::vec::Vectorized<float>::loadu(out_ptr8 + static_cast<long>(x2 + (272L*x1) + (73712L*x0)));
                    auto tmp16 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(1084L + x1)]));
                    auto tmp2 = tmp0 * tmp1;
                    auto tmp5 = tmp3 * tmp4;
                    auto tmp6 = tmp2 + tmp5;
                    auto tmp9 = tmp7 * tmp8;
                    ...
                    tmp18.store(in_out_ptr1 + static_cast<long>(x2 + (272L*x1) + (73712L*x0)));
                }
            }
        }
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(2L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(3L); x1+=static_cast<long>(1L))
            {
                ...
                {
                    auto tmp0 = in_out_ptr1[static_cast<long>(x2 + (73712L*x1) + (221136L*x0))];
                    out_ptr10[static_cast<long>(x1 + (3L*x2) + (221136L*x0))] = tmp0;
                }
            }
        }
    }
...
def call(args):
    ...
    buf5 = empty_strided((2, 3, 345, 272), (281520, 93840, 272, 1), device='cpu', dtype=torch.float32)
    buf6 = buf5; del buf5  # reuse
    buf7 = empty_strided((2, 3, 271, 272), (221136, 73712, 272, 1), device='cpu', dtype=torch.float32)
    buf9 = empty_strided((2, 3, 271, 272), (221136, 73712, 272, 1), device='cpu', dtype=torch.float32)
    buf10 = empty_strided((2, 3, 271, 272), (221136, 73712, 272, 1), device='cpu', dtype=torch.float32)
    buf11 = empty_strided((2, 3, 271, 272), (221136, 73712, 272, 1), device='cpu', dtype=torch.float32)
    buf12 = empty_strided((2, 3, 271, 272), (221136, 73712, 272, 1), device='cpu', dtype=torch.float32)
    buf8 = empty_strided((5, 271), (271, 1), device='cpu', dtype=torch.float32)
    buf13 = buf10; del buf10  # reuse
    buf14 = empty_strided((2, 3, 271, 272), (221136, 1, 816, 3), device='cpu', dtype=torch.float32)
    cpp_fused_add_clone_div_index_mul_sum_unbind_0(c_void_p(buf6.data_ptr()), c_void_p(buf13.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf7.data_ptr()), c_void_p(buf9.data_ptr()), c_void_p(buf11.data_ptr()), c_void_p(buf12.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf14.data_ptr()))
    del arg0_1
    return (buf14, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((2, 3, 345, 456), (471960, 1, 1368, 3), device='cpu', dtype=torch.float32)
