class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[2, 3, 345, 456]):
        ...
        lt: b8[5, 272] = torch.ops.aten.lt.Tensor(view_2, clamp_max_1);  clamp_max_1 = None
        add_4: i64[5, 272] = torch.ops.aten.add.Tensor(view_2, clamp_min);  view_2 = None
        ...
        lt_1: b8[5, 271] = torch.ops.aten.lt.Tensor(view_7, clamp_max_9);  clamp_max_9 = None
        add_19: i64[5, 271] = torch.ops.aten.add.Tensor(view_7, clamp_min_1);  view_7 = None
        ...
        where_1: f32[5, 271] = torch.ops.aten.where.self(lt_1, sub_7, full_default_2);  lt_1 = sub_7 = full_default_2 = None
        ...
        view_4: i64[1, 1, 1, 272] = torch.ops.aten.reshape.default(clamp_min, [1, 1, 1, 272]);  clamp_min = None
        ...
        index: f32[2, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_3]);  clamp_max_3 = None
        mul_2: f32[2, 3, 345, 272] = torch.ops.aten.mul.Tensor(index, getitem);  index = getitem = None
        ...
        index_1: f32[2, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_4]);  clamp_max_4 = None
        mul_3: f32[2, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_1, getitem_1);  index_1 = getitem_1 = None
        add_11: f32[2, 3, 345, 272] = torch.ops.aten.add.Tensor(mul_2, mul_3);  mul_2 = mul_3 = None
        ...
        index_2: f32[2, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_5]);  clamp_max_5 = None
        mul_4: f32[2, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_2, getitem_2);  index_2 = getitem_2 = None
        add_12: f32[2, 3, 345, 272] = torch.ops.aten.add.Tensor(add_11, mul_4);  add_11 = mul_4 = None
        ...
        index_3: f32[2, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_6]);  clamp_max_6 = None
        mul_5: f32[2, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_3, getitem_3);  index_3 = getitem_3 = None
        add_13: f32[2, 3, 345, 272] = torch.ops.aten.add.Tensor(add_12, mul_5);  add_12 = mul_5 = None
        ...
        index_4: f32[2, 3, 345, 272] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_7]);  arg0_1 = view = view_1 = view_3 = clamp_max_7 = None
        full_default_1: f32[272] = torch.ops.aten.full.default([272], 0.0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
        mul_6: f32[2, 3, 345, 272] = torch.ops.aten.mul.Tensor(index_4, full_default_1);  index_4 = full_default_1 = None
        add_14: f32[2, 3, 345, 272] = torch.ops.aten.add.Tensor(add_13, mul_6);  add_13 = mul_6 = None
        ...
        view_9: i64[1, 1, 271, 1] = torch.ops.aten.reshape.default(clamp_min_1, [1, 1, 271, 1]);  clamp_min_1 = None
        ...
        view_8: i64[1, 1, 1, 272] = torch.ops.aten.reshape.default(iota_9, [1, 1, 1, 272]);  iota_9 = None
        index_5: f32[2, 3, 271, 272] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_11, view_8]);  clamp_max_11 = None
        mul_9: f32[2, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_5, getitem_5);  index_5 = getitem_5 = None
        ...
        index_6: f32[2, 3, 271, 272] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_12, view_8]);  clamp_max_12 = None
        mul_10: f32[2, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_6, getitem_6);  index_6 = getitem_6 = None
        add_26: f32[2, 3, 271, 272] = torch.ops.aten.add.Tensor(mul_9, mul_10);  mul_9 = mul_10 = None
        ...
        index_7: f32[2, 3, 271, 272] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_13, view_8]);  clamp_max_13 = None
        mul_11: f32[2, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_7, getitem_7);  index_7 = getitem_7 = None
        add_27: f32[2, 3, 271, 272] = torch.ops.aten.add.Tensor(add_26, mul_11);  add_26 = mul_11 = None
        ...
        index_8: f32[2, 3, 271, 272] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_14, view_8]);  clamp_max_14 = None
        mul_12: f32[2, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_8, getitem_8);  index_8 = getitem_8 = None
        add_28: f32[2, 3, 271, 272] = torch.ops.aten.add.Tensor(add_27, mul_12);  add_27 = mul_12 = None
        ...
        index_9: f32[2, 3, 271, 272] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_15, view_8]);  add_14 = view_5 = view_6 = clamp_max_15 = view_8 = None
        mul_13: f32[2, 3, 271, 272] = torch.ops.aten.mul.Tensor(index_9, getitem_9);  index_9 = getitem_9 = None
        add_29: f32[2, 3, 271, 272] = torch.ops.aten.add.Tensor(add_28, mul_13);  add_28 = mul_13 = None
        clone: f32[2, 3, 271, 272] = torch.ops.aten.clone.default(add_29, memory_format = torch.channels_last);  add_29 = None
        return (clone,)
