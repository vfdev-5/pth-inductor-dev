...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1):
        ...
        unsqueeze = torch.ops.aten.unsqueeze.default(add_3, -1);  add_3 = None
        permute = torch.ops.aten.permute.default(arg1_1, [0, 2, 1]);  arg1_1 = None
        view_2 = torch.ops.aten.view.default(permute, [2, 1, 1, 3, 2]);  permute = None
        mul_4 = torch.ops.aten.mul.Tensor(unsqueeze, view_2);  unsqueeze = view_2 = None
        sum_1 = torch.ops.aten.sum.dim_IntList(mul_4, [-2]);  mul_4 = None
        view_3 = torch.ops.aten.view.default(sum_1, [2, 1, 345, 456, 2]);  sum_1 = None
        expand = torch.ops.aten.expand.default(view_3, [2, 3, 345, 456, 2]);  view_3 = None
        ...
        index = torch.ops.aten.index.Tensor(arg0_1, [view_4, view_5, where_3, where_2]);  where_3 = where_2 = None
        ...
        index_1 = torch.ops.aten.index.Tensor(arg0_1, [view_4, view_5, where_6, where_5]);  where_6 = where_5 = None
        ...
        index_2 = torch.ops.aten.index.Tensor(arg0_1, [view_4, view_5, where_9, where_8]);  where_9 = where_8 = None
        ...
        index_3 = torch.ops.aten.index.Tensor(arg0_1, [view_4, view_5, where_12, where_11]);  arg0_1 = view_4 = view_5 = where_12 = where_11 = None
