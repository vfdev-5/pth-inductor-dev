...
# kernel path: /tmp/torchinductor_root/hx/chx4lymbbyf2ef2mfludggxtvv6u4n5cqasbzbl7wywmcr6hpo6s.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 314640)
    x7 = xindex
    tmp43 = tl.load(in_ptr0 + ((3*x0) + (6*x3)), xmask, eviction_policy='evict_last')
    tmp53 = tl.load(in_ptr0 + (1 + (3*x0) + (6*x3)), xmask, eviction_policy='evict_last')
    tmp65 = tl.load(in_ptr0 + (2 + (3*x0) + (6*x3)), xmask, eviction_policy='evict_last')
...
# kernel path: /tmp/torchinductor_root/q2/cq2o6gruehsyypo5k4nc2qbc56yz7xqyobamaoxssc4sds4dhnnn.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp29 = tl.load(in_ptr1 + (tmp27 + (456*tmp24) + (157320*x3)), xmask)
    tmp30 = 1.0
    tmp31 = tmp5 + tmp30
    tmp32 = tmp31 - tmp4
    tmp33 = tmp15 + tmp30
    ...
    tmp46 = tl.load(in_ptr1 + (tmp44 + (456*tmp41) + (157320*x3)), xmask)
    tmp47 = tmp4 - tmp5
    tmp48 = tmp47 * tmp34
    ...
    tmp60 = tl.load(in_ptr1 + (tmp58 + (456*tmp56) + (157320*x3)), xmask)
    tmp61 = tmp14 - tmp15
    tmp62 = tmp32 * tmp61
    ...
    tmp77 = tl.load(in_ptr1 + (tmp69 + (456*tmp68) + (157320*x3)), xmask)
    tmp78 = tmp77 * tmp67
    tmp79 = tmp74 + tmp78
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf1 = empty_strided((2, 345, 456, 2), (314640, 912, 2, 1), device='cuda', dtype=torch.float32)
        ...
        triton_poi_fused_grid_sampler_2d_1.run(buf11, buf1, arg0_1, 943920, grid=grid(943920), stream=stream0)
        del arg0_1
        return (buf11, )
