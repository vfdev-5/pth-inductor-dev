class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[2, 3, 345, 456], arg1_1: f32[2, 2, 3]):
        ...
        sub_10: f32[2, 3, 345, 456] = torch.ops.aten.sub.Tensor(add_4, floor);  add_4 = None
        sub_11: f32[2, 3, 345, 456] = torch.ops.aten.sub.Tensor(add_5, floor_1);  add_5 = None
        ...
        convert_element_type_7: i64[2, 3, 345, 456] = torch.ops.prims.convert_element_type.default(floor_1, torch.int64);  floor_1 = None
        ...
        convert_element_type_8: i64[2, 3, 345, 456] = torch.ops.prims.convert_element_type.default(floor, torch.int64);  floor = None
