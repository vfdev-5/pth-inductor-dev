class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "u8[2, 3, 500, 500]"):
        ...
        ceil: "f32[256]" = torch.ops.aten.ceil.default(clamp_min)
        ...
        ceil_1: "f32[256]" = torch.ops.aten.ceil.default(clamp_min_1)
        ...
        unsqueeze: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(clamp_min, 1);  clamp_min = None
        ...
        _unsafe_index_2: "u8[2, 3, 256, 256]" = torch.ops.aten._unsafe_index.Tensor(arg0_1, [None, None, unsqueeze_1, convert_element_type_3])
        ...
        sub_2: "f32[256, 1]" = torch.ops.aten.sub.Tensor(unsqueeze, unsqueeze_1);  unsqueeze = unsqueeze_1 = None
        sub_3: "f32[256, 1]" = torch.ops.aten.sub.Tensor(1.0, sub_2)
        sub_4: "f32[256]" = torch.ops.aten.sub.Tensor(clamp_min_1, convert_element_type_2);  clamp_min_1 = convert_element_type_2 = None
