class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[2, 3, 345, 456]):
        ...
        full_default: f32[] = torch.ops.aten.full.default([], 1.6888889074325562, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        iota_2: i64[270] = torch.ops.prims.iota.default(270, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        sub: f32[270] = torch.ops.aten.sub.Tensor(mul_1, full_default)
        ...
        add_3: f32[270] = torch.ops.aten.add.Tensor(mul_1, full_default);  full_default = None
        ...
        iota_3: i64[5] = torch.ops.prims.iota.default(5, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        iota_4: i64[345] = torch.ops.prims.iota.default(345, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        full_default_2: f32[270] = torch.ops.aten.full.default([270], 0.0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        iota_5: i64[2] = torch.ops.prims.iota.default(2, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        view_5: i64[2, 1, 1, 1] = torch.ops.aten.view.default(iota_5, [2, 1, 1, 1]);  iota_5 = None
        iota_6: i64[3] = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        view_6: i64[1, 3, 1, 1] = torch.ops.aten.view.default(iota_6, [1, 3, 1, 1]);  iota_6 = None
        _tensor_constant1 = self._tensor_constant1
        full_default_3: f32[] = torch.ops.aten.full.default([], 1.2777777910232544, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        iota_7: i64[270] = torch.ops.prims.iota.default(270, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        sub_4: f32[270] = torch.ops.aten.sub.Tensor(mul_9, full_default_3)
        ...
        add_19: f32[270] = torch.ops.aten.add.Tensor(mul_9, full_default_3);  full_default_3 = None
        ...
        iota_8: i64[5] = torch.ops.prims.iota.default(5, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        view_7: i64[5, 1] = torch.ops.aten.view.default(iota_8, [-1, 1]);  iota_8 = None
        add_21: i64[5, 270] = torch.ops.aten.add.Tensor(view_7, clamp_min_2)
        ...
        view_8: i64[1, 1, 270, 1] = torch.ops.aten.view.default(clamp_min_2, [1, 1, 270, 1]);  clamp_min_2 = None
        iota_9: i64[270] = torch.ops.prims.iota.default(270, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        view_9: i64[1, 1, 1, 270] = torch.ops.aten.view.default(iota_9, [1, 1, 1, 270]);  iota_9 = None
