...
class Repro(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.register_buffer('_tensor_constant0', tensor(1.6889, device='cuda:0').cuda())
        self.register_buffer('_tensor_constant1', tensor(1.2778, device='cuda:0').cuda())
    ...
    def forward(self, arg0_1):
        ...
        iota_1 = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        view_1 = torch.ops.aten.view.default(iota_1, [1, 3, 1, 1]);  iota_1 = None
        _tensor_constant0 = self._tensor_constant0
        full_default = torch.ops.aten.full.default([], 1.6888889074325562, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        iota_2 = torch.ops.prims.iota.default(270, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        iota_3 = torch.ops.prims.iota.default(5, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        iota_4 = torch.ops.prims.iota.default(345, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        full_default_2 = torch.ops.aten.full.default([270], 0.0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        iota_5 = torch.ops.prims.iota.default(2, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        view_5 = torch.ops.aten.view.default(iota_5, [2, 1, 1, 1]);  iota_5 = None
        iota_6 = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        view_6 = torch.ops.aten.view.default(iota_6, [1, 3, 1, 1]);  iota_6 = None
        _tensor_constant1 = self._tensor_constant1
        full_default_3 = torch.ops.aten.full.default([], 1.2777777910232544, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        iota_7 = torch.ops.prims.iota.default(270, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        iota_8 = torch.ops.prims.iota.default(5, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
        ...
        iota_9 = torch.ops.prims.iota.default(270, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
