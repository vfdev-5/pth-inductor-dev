class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "u8[2, 3, 500, 500]"):
        ...
        add_2: "i32[256]" = torch.ops.aten.add.Tensor(convert_element_type, 1)
        ...
        add_3: "i32[256]" = torch.ops.aten.add.Tensor(convert_element_type_1, 1)
        ...
        view_1: "f32[256, 2, 1, 1]" = torch.ops.aten.view.default(cat_3, [256, 2, 1, 1]);  cat_3 = None
        view_2: "f32[1, 256, 2]" = torch.ops.aten.view.default(cat_2, [1, 256, 2]);  cat_2 = None
