class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "u8[2, 3, 500, 500]"):
        ...
        sub_4: "f32[256]" = torch.ops.aten.sub.Tensor(clamp_min_1, convert_element_type_1);  clamp_min_1 = None
        ...
        unsqueeze_6: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(sub_5, 1);  sub_5 = None
        unsqueeze_7: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(clamp_max_3, 1);  clamp_max_3 = None
        cat_3: "f32[256, 2]" = torch.ops.aten.cat.default([unsqueeze_6, unsqueeze_7], -1);  unsqueeze_6 = unsqueeze_7 = None
        view_1: "f32[256, 2, 1, 1]" = torch.ops.aten.reshape.default(cat_3, [256, 2, 1, 1]);  cat_3 = None
        ...
        sub_2: "f32[256]" = torch.ops.aten.sub.Tensor(clamp_min, convert_element_type);  clamp_min = None
        ...
        unsqueeze_4: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(sub_3, 1);  sub_3 = None
        unsqueeze_5: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(clamp_max_2, 1);  clamp_max_2 = None
        cat_2: "f32[256, 2]" = torch.ops.aten.cat.default([unsqueeze_4, unsqueeze_5], -1);  unsqueeze_4 = unsqueeze_5 = None
        view_2: "f32[1, 256, 2]" = torch.ops.aten.reshape.default(cat_2, [1, 256, 2]);  cat_2 = None
        unsqueeze_2: "i32[256, 1]" = torch.ops.aten.unsqueeze.default(convert_element_type_1, 1)
        add_3: "i32[256]" = torch.ops.aten.add.Tensor(convert_element_type_1, 1);  convert_element_type_1 = None
        unsqueeze_3: "i32[256, 1]" = torch.ops.aten.unsqueeze.default(add_3, 1);  add_3 = None
        cat_1: "i32[256, 2]" = torch.ops.aten.cat.default([unsqueeze_2, unsqueeze_3], -1);  unsqueeze_2 = unsqueeze_3 = None
        clamp_max_1: "i32[256, 2]" = torch.ops.aten.clamp_max.default(cat_1, 499);  cat_1 = None
        view: "i32[256, 2, 1, 1]" = torch.ops.aten.reshape.default(clamp_max_1, [256, 2, 1, 1]);  clamp_max_1 = None
        unsqueeze: "i32[256, 1]" = torch.ops.aten.unsqueeze.default(convert_element_type, 1)
        add_2: "i32[256]" = torch.ops.aten.add.Tensor(convert_element_type, 1);  convert_element_type = None
        unsqueeze_1: "i32[256, 1]" = torch.ops.aten.unsqueeze.default(add_2, 1);  add_2 = None
        cat: "i32[256, 2]" = torch.ops.aten.cat.default([unsqueeze, unsqueeze_1], -1);  unsqueeze = unsqueeze_1 = None
        clamp_max: "i32[256, 2]" = torch.ops.aten.clamp_max.default(cat, 499);  cat = None
