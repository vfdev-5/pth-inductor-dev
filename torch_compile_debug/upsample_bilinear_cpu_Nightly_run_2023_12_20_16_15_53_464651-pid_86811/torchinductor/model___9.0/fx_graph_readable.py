class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "Sym(s0)", arg1_1: "Sym(s1)", arg2_1: "Sym(s2)", arg3_1: "f32[1, s0, s1, s2]", arg4_1: "Sym(s3)", arg5_1: "Sym(s4)"):
        ...
        _unsafe_index: "f32[1, s0, s3, s4]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, convert_element_type_3, convert_element_type_2])
        _unsafe_index_1: "f32[1, s0, s3, s4]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, convert_element_type_3, where])
        _unsafe_index_2: "f32[1, s0, s3, s4]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, where_1, convert_element_type_2])
        _unsafe_index_3: "f32[1, s0, s3, s4]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, where_1, where]);  arg3_1 = where_1 = where = None
        ...
        sub_9: "f32[s4]" = torch.ops.aten.sub.Tensor(clamp_min, convert_element_type_2);  clamp_min = convert_element_type_2 = None
        ...
        mul_2: "f32[1, s0, s3, s4]" = torch.ops.aten.mul.Tensor(sub_10, clamp_max_1);  sub_10 = None
        ...
        mul_3: "f32[1, s0, s3, s4]" = torch.ops.aten.mul.Tensor(sub_11, clamp_max_1);  sub_11 = clamp_max_1 = None
