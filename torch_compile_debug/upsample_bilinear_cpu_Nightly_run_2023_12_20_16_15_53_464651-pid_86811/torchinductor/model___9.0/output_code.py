        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks1); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks2); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp10 = c10::convert<long>((-1L) + ks3);
                    ...
                    auto tmp18 = c10::convert<float>(ks4*(1.0/ks2));
                    ...
                    auto tmp23 = c10::convert<long>((-1L) + ks4);
                    auto tmp24 = tmp22 < tmp23;
                    auto tmp25 = decltype(tmp22)(tmp22 + tmp12);
                    auto tmp26 = tmp24 ? tmp25 : tmp22;
                    auto tmp27 = in_ptr0[static_cast<long>(tmp26 + (ks4*tmp14) + (ks3*ks4*x0))];
                    auto tmp28 = in_ptr0[static_cast<long>(tmp22 + (ks4*tmp14) + (ks3*ks4*x0))];
                    auto tmp29 = in_ptr0[static_cast<long>(tmp26 + (ks4*tmp9) + (ks3*ks4*x0))];
                    auto tmp30 = in_ptr0[static_cast<long>(tmp22 + (ks4*tmp9) + (ks3*ks4*x0))];
                    ...
                    in_out_ptr1[static_cast<long>(x2 + (ks2*x1) + (ks1*ks2*x0))] = tmp48;
                }
            }
        }
    }
...
def call(args):
    ...
    cpp_fused__to_copy__unsafe_index_add_arange_clamp_mul_sub_0(c_void_p(buf5.data_ptr()), c_void_p(arg3_1.data_ptr()), c_long(s0), c_long(s3), c_long(s4), c_long(s1), c_long(s2))
    del arg3_1
    return (buf5, )
