class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "Sym(s0)", arg1_1: "Sym(s1)", arg2_1: "Sym(s2)", arg3_1: "Sym(s3)", arg4_1: "u8[s0, s1, s2, s3]", arg5_1: "Sym(s4)", arg6_1: "Sym(s5)"):
        ...
        sub_10: "f32[s4]" = torch.ops.aten.sub.Tensor(clamp_min_1, convert_element_type_1);  clamp_min_1 = None
        ...
        view_1: "f32[s4, 2, 1, 1]" = torch.ops.aten.reshape.default(cat_1, [arg5_1, 2, 1, 1]);  cat_1 = arg5_1 = None
        ...
        sub_8: "f32[s5]" = torch.ops.aten.sub.Tensor(clamp_min, convert_element_type);  clamp_min = None
        ...
        view_2: "f32[1, s5, 2]" = torch.ops.aten.reshape.default(cat, [1, arg6_1, 2]);  cat = arg6_1 = None
        unsqueeze_1: "i64[s4, 1]" = torch.ops.aten.unsqueeze.default(convert_element_type_1, -1);  convert_element_type_1 = None
        ...
        view: "i64[s4, 2, 1, 1]" = torch.ops.aten.reshape.default(clamp_max_1, [floordiv, 2, 1, 1]);  clamp_max_1 = floordiv = None
        unsqueeze: "i64[s5, 1]" = torch.ops.aten.unsqueeze.default(convert_element_type, -1);  convert_element_type = None
