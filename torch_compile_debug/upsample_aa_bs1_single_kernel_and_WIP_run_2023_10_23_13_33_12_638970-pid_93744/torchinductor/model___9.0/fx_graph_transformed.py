class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[1, 3, 500, 400]):
        ...
        view_6: i32[256, 1] = torch.ops.aten.reshape.default(clamp_max_4, [-1, 1]);  clamp_max_4 = None
        lt_1: b8[256, 5] = torch.ops.aten.lt.Tensor(iota_3, view_6);  view_6 = None
        view_5: i32[256, 1] = torch.ops.aten.reshape.default(clamp_min_1, [-1, 1]);  clamp_min_1 = None
        add_10: i32[256, 5] = torch.ops.aten.add.Tensor(iota_3, view_5);  iota_3 = None
        view_4: f32[256, 1] = torch.ops.aten.reshape.default(mul_2, [-1, 1]);  mul_2 = None
        ...
        view_9: f32[256, 5, 1, 1] = torch.ops.aten.reshape.default(div_1, [256, 5, 1, 1]);  div_1 = None
        ...
        view_2: i32[256, 1] = torch.ops.aten.reshape.default(clamp_max_1, [-1, 1]);  clamp_max_1 = None
        lt: b8[256, 5] = torch.ops.aten.lt.Tensor(iota_1, view_2);  view_2 = None
        view_1: i32[256, 1] = torch.ops.aten.reshape.default(clamp_min, [-1, 1]);  clamp_min = None
        add_4: i32[256, 5] = torch.ops.aten.add.Tensor(iota_1, view_1);  iota_1 = None
        view: f32[256, 1] = torch.ops.aten.reshape.default(mul, [-1, 1]);  mul = None
        ...
        view_10: f32[1, 256, 5] = torch.ops.aten.reshape.default(div, [1, 256, 5]);  div = None
        view_7: i32[256] = torch.ops.aten.reshape.default(view_5, [-1]);  view_5 = None
        ...
        view_8: i64[256, 5, 1, 1] = torch.ops.aten.reshape.default(clamp_max_7, [256, 5, 1, 1]);  clamp_max_7 = None
        view_3: i32[256] = torch.ops.aten.reshape.default(view_1, [-1]);  view_1 = None
        ...
        index: f32[1, 3, 256, 5, 256, 5] = torch.ops.aten.index.Tensor(arg0_1, [None, None, view_8, clamp_max_6]);  arg0_1 = view_8 = clamp_max_6 = None
        mul_4: f32[1, 3, 256, 5, 256, 5] = torch.ops.aten.mul.Tensor(view_10, index);  view_10 = index = None
        mul_5: f32[1, 3, 256, 5, 256, 5] = torch.ops.aten.mul.Tensor(view_9, mul_4);  view_9 = mul_4 = None
        sum_3: f32[1, 3, 256, 256] = torch.ops.aten.sum.dim_IntList(mul_5, [-1, -3]);  mul_5 = None
        return (sum_3,)
