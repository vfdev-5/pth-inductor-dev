class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[1, 3, 500, 400]):
        ...
        slice_1: f32[1, 3, 500, 400] = torch.ops.aten.slice.Tensor(arg0_1, 0, 0, 9223372036854775807);  arg0_1 = None
        slice_2: f32[1, 3, 500, 400] = torch.ops.aten.slice.Tensor(slice_1, 1, 0, 9223372036854775807);  slice_1 = None
        index: f32[1, 3, 256, 5, 256, 5] = torch.ops.aten.index.Tensor(slice_2, [None, None, view_8, clamp_max_6]);  slice_2 = view_8 = clamp_max_6 = None
