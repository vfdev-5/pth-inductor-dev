class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[1, 3, 345, 456]):
        ...
        clone: f32[1, 3, 345, 272] = torch.ops.aten.clone.default(add_14, memory_format = torch.channels_last);  add_14 = None
        ...
        index_5: f32[1, 3, 271, 272] = torch.ops.aten.index.Tensor(clone, [full_default_3, view_6, clamp_max_11, view_8]);  clamp_max_11 = None
        ...
        index_6: f32[1, 3, 271, 272] = torch.ops.aten.index.Tensor(clone, [full_default_3, view_6, clamp_max_12, view_8]);  clamp_max_12 = None
        ...
        index_7: f32[1, 3, 271, 272] = torch.ops.aten.index.Tensor(clone, [full_default_3, view_6, clamp_max_13, view_8]);  clamp_max_13 = None
        ...
        index_8: f32[1, 3, 271, 272] = torch.ops.aten.index.Tensor(clone, [full_default_3, view_6, clamp_max_14, view_8]);  clamp_max_14 = None
        ...
        index_9: f32[1, 3, 271, 272] = torch.ops.aten.index.Tensor(clone, [full_default_3, view_6, clamp_max_15, view_8]);  clone = full_default_3 = view_6 = clamp_max_15 = view_8 = None
        ...
        clone_1: f32[1, 3, 271, 272] = torch.ops.aten.clone.default(add_29, memory_format = torch.channels_last);  add_29 = None
        return (clone_1,)
