                       ...
                       float* out_ptr0)
{
    {
        #pragma GCC ivdep
        for(long i0=static_cast<long>(0L); i0<static_cast<long>(157320L); i0+=static_cast<long>(1L))
        {
            #pragma GCC ivdep
            for(long i1=static_cast<long>(0L); i1<static_cast<long>(2L); i1+=static_cast<long>(1L))
            {
                auto tmp46 = in_ptr0[static_cast<long>(3L*i1)];
                auto tmp88 = in_ptr0[static_cast<long>(1L + (3L*i1))];
                auto tmp132 = in_ptr0[static_cast<long>(2L + (3L*i1))];
                auto tmp0 = static_cast<long>(0);
                auto tmp1 = static_cast<long>(1);
                auto tmp2 = tmp0 < tmp1;
                auto tmp3 = [&]
                {
                    auto tmp4 = static_cast<long>(static_cast<long>(i0) % static_cast<long>(456L));
                    ...
                    auto tmp12 = static_cast<long>(455L + ((-1L)*(static_cast<long>(i0) % static_cast<long>(456L))));
                ...
                auto tmp23 = [&]
                {
                    auto tmp24 = static_cast<long>(at::native::div_floor_integer(i0, 456L));
                    ...
                    auto tmp32 = static_cast<long>(344L + ((-1L)*(at::native::div_floor_integer(i0, 456L))));
                ...
                auto tmp49 = [&]
                {
                    auto tmp50 = static_cast<long>(static_cast<long>(i0) % static_cast<long>(456L));
                    ...
                    auto tmp58 = static_cast<long>(455L + ((-1L)*(static_cast<long>(i0) % static_cast<long>(456L))));
                ...
                auto tmp67 = [&]
                {
                    auto tmp68 = static_cast<long>(at::native::div_floor_integer(i0, 456L));
                    ...
                    auto tmp76 = static_cast<long>(344L + ((-1L)*(at::native::div_floor_integer(i0, 456L))));
                ...
                auto tmp93 = [&]
                {
                    auto tmp94 = static_cast<long>(static_cast<long>(i0) % static_cast<long>(456L));
                    ...
                    auto tmp102 = static_cast<long>(455L + ((-1L)*(static_cast<long>(i0) % static_cast<long>(456L))));
                ...
                auto tmp111 = [&]
                {
                    auto tmp112 = static_cast<long>(at::native::div_floor_integer(i0, 456L));
                    ...
                    auto tmp120 = static_cast<long>(344L + ((-1L)*(at::native::div_floor_integer(i0, 456L))));
                ...
                out_ptr0[static_cast<long>(i1 + (2L*i0))] = tmp134;
            }
        }
    }
    {
        ...
        for(long i0=static_cast<long>(0L); i0<static_cast<long>(3L); i0+=static_cast<long>(1L))
        {
            ...
            {
                auto tmp0 = out_ptr0[static_cast<long>(2L*i1)];
                auto tmp10 = out_ptr0[static_cast<long>(1L + (2L*i1))];
                ...
                auto tmp27 = in_ptr1[static_cast<long>(i0 + (3L*tmp26) + (1368L*tmp24))];
                ...
                auto tmp42 = in_ptr1[static_cast<long>(i0 + (3L*tmp41) + (1368L*tmp39))];
                ...
                auto tmp54 = in_ptr1[static_cast<long>(i0 + (3L*tmp53) + (1368L*tmp52))];
                ...
                auto tmp69 = in_ptr1[static_cast<long>(i0 + (3L*tmp63) + (1368L*tmp62))];
...
def call(args):
    ...
    buf10 = empty_strided((1, 3, 345, 456), (471960, 157320, 456, 1), device='cpu', dtype=torch.float32)
    buf11 = buf10; del buf10  # reuse
    cpp_fused_affine_grid_generator_grid_sampler_2d_0(c_void_p(buf11.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(buf1.data_ptr()))
    del arg0_1
    del arg1_1
    return (buf11, )
