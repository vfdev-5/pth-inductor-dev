...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1):
        iota = torch.ops.prims.iota.default(272, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
        ...
        view = torch.ops.aten.view.default(iota_1, [-1, 1]);  iota_1 = None
        add_4 = torch.ops.aten.add.Tensor(view, clamp_min)
        ...
        lt = torch.ops.aten.lt.Tensor(view, clamp_max_1);  view = clamp_max_1 = None
        ...
        view_1 = torch.ops.aten.view.default(iota_2, [-1, 1]);  iota_2 = None
        add_6 = torch.ops.aten.add.Tensor(clamp_min, view_1);  clamp_min = view_1 = None
