class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[4, 3, 345, 456]):
        ...
        view: i64[5, 1] = torch.ops.aten.reshape.default(iota_1, [-1, 1]);  iota_1 = None
        ...
        lt: b8[5, 272] = torch.ops.aten.lt.Tensor(view, clamp_max_1);  clamp_max_1 = None
        add_4: i64[5, 272] = torch.ops.aten.add.Tensor(view, clamp_min);  view = None
        ...
        view_1: i64[5, 1] = torch.ops.aten.reshape.default(iota_2, [-1, 1]);  iota_2 = None
        ...
        index: f32[4, 3, 345, 5, 272] = torch.ops.aten.index.Tensor(arg0_1, [None, None, None, clamp_max_3]);  arg0_1 = clamp_max_3 = None
