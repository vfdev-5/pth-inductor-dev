                       ...
                       long* out_ptr8)
{
    auto out_ptr9 = in_out_ptr0;
    {
        ...
        {
            #pragma GCC ivdep
            for(long i1=static_cast<long>(0L); i1<static_cast<long>(345L); i1+=static_cast<long>(1L))
            {
                #pragma GCC ivdep
                for(long i2=static_cast<long>(0L); i2<static_cast<long>(456L); i2+=static_cast<long>(1L))
                {
                    #pragma GCC ivdep
                    for(long i3=static_cast<long>(0L); i3<static_cast<long>(2L); i3+=static_cast<long>(1L))
                    {
                        auto tmp46 = in_ptr0[static_cast<long>((3L*i3) + (6L*i0))];
                        auto tmp88 = in_ptr0[static_cast<long>(1L + (3L*i3) + (6L*i0))];
                        auto tmp132 = in_ptr0[static_cast<long>(2L + (3L*i3) + (6L*i0))];
                        auto tmp0 = static_cast<long>(0);
                        auto tmp1 = static_cast<long>(1);
                        auto tmp2 = tmp0 < tmp1;
                        auto tmp3 = [&]
                        {
                            auto tmp4 = static_cast<long>(i2);
                            ...
                            auto tmp12 = static_cast<long>(455L + ((-1L)*i2));
                        ...
                        auto tmp23 = [&]
                        {
                            auto tmp24 = static_cast<long>(i1);
                            ...
                            auto tmp32 = static_cast<long>(344L + ((-1L)*i1));
                        ...
                        auto tmp49 = [&]
                        {
                            auto tmp50 = static_cast<long>(i2);
                            ...
                            auto tmp58 = static_cast<long>(455L + ((-1L)*i2));
                        ...
                        auto tmp67 = [&]
                        {
                            auto tmp68 = static_cast<long>(i1);
                            ...
                            auto tmp76 = static_cast<long>(344L + ((-1L)*i1));
                        ...
                        auto tmp93 = [&]
                        {
                            auto tmp94 = static_cast<long>(i2);
                            ...
                            auto tmp102 = static_cast<long>(455L + ((-1L)*i2));
                        ...
                        auto tmp111 = [&]
                        {
                            auto tmp112 = static_cast<long>(i1);
                            ...
                            auto tmp120 = static_cast<long>(344L + ((-1L)*i1));
                        ...
                        out_ptr0[static_cast<long>(i3 + (2L*i2) + (912L*i1) + (314640L*i0))] = tmp134;
                    }
                }
            }
        }
...
def call(args):
    ...
    buf1 = empty_strided((2, 345, 456, 2), (314640, 912, 2, 1), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((2, 2, 3), (6, 3, 1), device='cpu', dtype=torch.float32)
