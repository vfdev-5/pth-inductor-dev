...
# kernel path: /tmp/torchinductor_root/z4/cz4dq6tjnj57cacavirjwjkxf4sfezfctitk5e2zvsrnhojinh3s.py
# Original ATen: aten.affine_grid_generator

# aten.affine_grid_generator => add_2, add_3, constant_pad_nd, constant_pad_nd_1, constant_pad_nd_2
...
@pointwise(size_hints=[524288], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'constants': {}, 'mutated_arg_names': [], 'configs': [instance_descriptor(divisible_by_16=(0,), equal_to_1=())]})
@triton.jit
def triton_(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp25 = 172.5
    tmp26 = tmp24 < tmp25
    tmp27 = 0.005797101449275362
    tmp28 = tmp24 * tmp27
    tmp29 = -0.9971014492753624
    tmp30 = tmp28 + tmp29
    tmp31 = 344 + ((-1)*x2)
    tmp32 = tmp31.to(tl.float32)
    tmp33 = tmp32 * tmp27
    tmp34 = 0.9971014492753624
    tmp35 = tmp34 - tmp33
    tmp36 = tl.where(tmp26, tmp30, tmp35)
    tmp37 = tl.where(tmp22, tmp36, 0.0)
    tmp38 = tmp17 + tmp37
    tmp39 = (-2) + x0
    tmp40 = tmp39 >= tmp19
    tmp41 = 1.0
    ...
    tmp43 = tmp38 + tmp42
    tl.store(out_ptr0 + (x5), tmp43, xmask)
''')
...
# aten.grid_sampler_2d => add_10, add_4, add_5, add_6, add_7, add_8, add_9, convert_element_type_10, convert_element_type_11, floor, floor_1, full_default_10, full_default_11, full_default_2, full_default_5, full_default_8, full_default_9, ge, ge_1, ge_2, ge_3, ge_4, ge_5, ge_6, ge_7, index, index_1, index_2, index_3, logical_and, logical_and_1, logical_and_10, logical_and_11, logical_and_2, logical_and_3, logical_and_4, logical_and_5, logical_and_6, logical_and_7, logical_and_8, logical_and_9, lt_2, lt_3, lt_4, lt_5, lt_6, lt_7, lt_8, lt_9, mul_10, mul_11, mul_12, mul_13, mul_4, mul_5, mul_6, mul_7, mul_8, mul_9, sub_10, sub_11, sub_4, sub_5, sub_6, sub_7, sub_8, sub_9, where_10, where_11, where_12, where_13, where_4, where_7
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty_strided((1, 345, 456, 3), (471960, 1368, 3, 1), device='cuda', dtype=torch.float32)
        stream0 = get_cuda_stream(0)
        triton_poi_fused_affine_grid_generator_0.run(buf0, 471960, grid=grid(471960), stream=stream0)
