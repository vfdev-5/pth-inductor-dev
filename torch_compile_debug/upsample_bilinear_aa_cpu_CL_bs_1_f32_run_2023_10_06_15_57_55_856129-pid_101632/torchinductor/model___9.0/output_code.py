        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(3L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(271L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(272L); x2+=static_cast<long>(1L))
                {
                    ...
                    out_ptr10[static_cast<long>(x0 + (3L*x2) + (816L*x1))] = tmp72;
                }
            }
        }
    }
...
def call(args):
    ...
    buf13 = empty_strided((1, 3, 271, 272), (221136, 1, 816, 3), device='cpu', dtype=torch.float32)
    cpp_fused_add_clone_div_index_mul_sum_unbind_0(c_void_p(buf6.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf13.data_ptr()))
    del arg0_1
    return (buf13, )
