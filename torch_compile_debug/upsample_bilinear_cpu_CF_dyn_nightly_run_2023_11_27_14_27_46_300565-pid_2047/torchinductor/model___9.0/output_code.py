                       ...
                       const long ks4)
{
    auto out_ptr0 = in_out_ptr0;
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1); x0+=static_cast<long>(1L))
        {
            ...
            {
                #pragma GCC ivdep
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks3); x2+=static_cast<long>(1L))
                {
                    auto tmp0 = c10::convert<unsigned char>(x1);
                    auto tmp1 = c10::convert<float>(tmp0);
                    auto tmp2 = static_cast<float>(0.5);
                    auto tmp3 = decltype(tmp1)(tmp1 + tmp2);
                    auto tmp4 = c10::convert<float>(ks4*(1.0/ks2));
                    ...
                    auto tmp13 = c10::convert<float>(ks4*(1.0/ks3));
                    auto tmp14 = decltype(tmp12)(tmp12 * tmp13);
                    auto tmp15 = decltype(tmp14)(tmp14 - tmp2);
                    auto tmp16 = max_propagate_nan(tmp15, tmp7);
                    auto tmp17 = c10::convert<long>(tmp16);
                    auto tmp18 = in_ptr0[static_cast<long>(tmp17 + (ks4*tmp9) + (x0*(static_cast<long>(ks4*ks4))))];
                    ...
                    out_ptr0[static_cast<long>(x2 + (ks3*x1) + (ks2*ks3*x0))] = tmp24;
                }
            }
        }
    }
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks2); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks3); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp10 = c10::convert<float>((-1L) + ks4);
                    ...
                    auto tmp15 = decltype(tmp14)(tmp14 + tmp2);
                    auto tmp16 = c10::convert<float>(ks4*(1.0/ks3));
                    ...
                    auto tmp21 = in_ptr0[static_cast<long>(tmp20 + (ks4*tmp12) + (x0*(static_cast<long>(ks4*ks4))))];
                    ...
                    out_ptr1[static_cast<long>(x2 + (ks3*x1) + (ks2*ks3*x0))] = tmp26;
                }
            }
        }
    }
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks2); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks3); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp20 = c10::convert<long>(tmp19);
                    auto tmp21 = in_ptr0[static_cast<long>(tmp20 + (ks4*tmp9) + (x0*(static_cast<long>(ks4*ks4))))];
                    auto tmp22 = c10::convert<float>(tmp21);
                    ...
                    out_ptr2[static_cast<long>(x2 + (ks3*x1) + (ks2*ks3*x0))] = tmp27;
                }
            }
        }
    }
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks2); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks3); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp21 = min_propagate_nan(tmp20, tmp10);
                    auto tmp22 = c10::convert<long>(tmp21);
                    auto tmp23 = in_ptr0[static_cast<long>(tmp22 + (ks4*tmp12) + (x0*(static_cast<long>(ks4*ks4))))];
                    auto tmp24 = c10::convert<float>(tmp23);
                    ...
                    out_ptr3[static_cast<long>(x2 + (ks3*x1) + (ks2*ks3*x0))] = tmp28;
                }
            }
        }
    }
    {
        #pragma GCC ivdep
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1*ks2); x0+=static_cast<long>(1L))
        {
            #pragma GCC ivdep
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks3); x1+=static_cast<long>(1L))
            {
                auto tmp0 = out_ptr0[static_cast<long>(x1 + (ks3*x0))];
                auto tmp1 = out_ptr1[static_cast<long>(x1 + (ks3*x0))];
                auto tmp18 = out_ptr2[static_cast<long>(x1 + (ks3*x0))];
                auto tmp19 = out_ptr3[static_cast<long>(x1 + (ks3*x0))];
                auto tmp2 = decltype(tmp0)(tmp0 + tmp1);
                auto tmp3 = c10::convert<unsigned char>(x1);
                auto tmp4 = c10::convert<float>(tmp3);
                auto tmp5 = static_cast<float>(0.5);
                auto tmp6 = decltype(tmp4)(tmp4 + tmp5);
                auto tmp7 = c10::convert<float>(ks4*(1.0/ks3));
                ...
                in_out_ptr0[static_cast<long>(x1 + (ks3*x0))] = tmp22;
            }
        }
    }
    {
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(8L*(c10::div_floor_integer((ks0*ks1*ks2*ks3), 8L))); x0+=static_cast<long>(8L))
        {
        ...
        for(long x0=static_cast<long>(8L*(c10::div_floor_integer((ks0*ks1*ks2*ks3), 8L))); x0<static_cast<long>(ks0*ks1*ks2*ks3); x0+=static_cast<long>(1L))
        {
...
def call(args):
    ...
    buf0 = empty_strided((s0, s1, s3, s4), (s3*s4*s1, s3*s4, s4, 1), device='cpu', dtype=torch.float32)
    buf1 = empty_strided((s0, s1, s3, s4), (s3*s4*s1, s3*s4, s4, 1), device='cpu', dtype=torch.float32)
    buf2 = empty_strided((s0, s1, s3, s4), (s3*s4*s1, s3*s4, s4, 1), device='cpu', dtype=torch.float32)
    buf3 = empty_strided((s0, s1, s3, s4), (s3*s4*s1, s3*s4, s4, 1), device='cpu', dtype=torch.float32)
    buf4 = buf0; del buf0  # reuse
    buf5 = empty_strided((s0, s1, s3, s4), (s3*s4*s1, s3*s4, s4, 1), device='cpu', dtype=torch.uint8)
    cpp_fused__to_copy__unsafe_index_add_arange_clamp_mul_rsub_sub_0(c_void_p(buf4.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf5.data_ptr()), c_long(s0), c_long(s1), c_long(s3), c_long(s4), c_long(s2))
    del arg3_1
    return (buf5, )
