...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1):
        iota = torch.ops.prims.iota.default(256, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
        iota_1 = torch.ops.prims.iota.default(256, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
        ...
        iota_2 = torch.ops.prims.iota.default(2, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
        iota_3 = torch.ops.prims.iota.default(2, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
        unsqueeze = torch.ops.aten.unsqueeze.default(convert_element_type, -1)
        add_2 = torch.ops.aten.add.Tensor(unsqueeze, iota_2);  unsqueeze = iota_2 = None
        clamp_max = torch.ops.aten.clamp_max.default(add_2, 499);  add_2 = None
        unsqueeze_1 = torch.ops.aten.unsqueeze.default(convert_element_type_1, -1)
        add_3 = torch.ops.aten.add.Tensor(unsqueeze_1, iota_3);  unsqueeze_1 = iota_3 = None
        clamp_max_1 = torch.ops.aten.clamp_max.default(add_3, 499);  add_3 = None
        ...
        unsqueeze_2 = torch.ops.aten.unsqueeze.default(sub_3, 1);  sub_3 = None
        ...
        unsqueeze_4 = torch.ops.aten.unsqueeze.default(sub_5, 1);  sub_5 = None
        ...
        view_1 = torch.ops.aten.view.default(cat_1, [256, 2, 1, 1]);  cat_1 = None
        view_2 = torch.ops.aten.view.default(cat, [1, 256, 2]);  cat = None
