...
@pointwise(size_hints=[8, 262144], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr24, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    xnumel = 157320
    ...
    y3 = yindex
    y0 = yindex % 3
    tmp0 = tl.load(in_ptr0 + ((2*x2) + (314640*y1)), xmask & ymask, eviction_policy='evict_last')
    tmp12 = tl.load(in_ptr0 + (1 + (2*x2) + (314640*y1)), xmask & ymask, eviction_policy='evict_last')
    tmp1 = 228.0
    tmp2 = tmp0 * tmp1
    tmp3 = 227.5
    tmp4 = tmp2 + tmp3
    ...
    tmp31 = tl.load(in_ptr1 + (y0 + (3*tmp30) + (1368*tmp28) + (471960*y1)), ymask)
    ...
    tmp44 = tl.load(in_ptr1 + (y0 + (3*tmp43) + (1368*tmp41) + (471960*y1)), ymask)
    ...
    tmp57 = tl.load(in_ptr1 + (y0 + (3*tmp56) + (1368*tmp54) + (471960*y1)), ymask)
    ...
    tmp70 = tl.load(in_ptr1 + (y0 + (3*tmp69) + (1368*tmp68) + (471960*y1)), ymask)
    ...
    tmp78 = tl.load(in_ptr1 + (y0 + (3*tmp77) + (1368*tmp76) + (471960*y1)), ymask)
    ...
    tmp86 = tl.load(in_ptr1 + (y0 + (3*tmp85) + (1368*tmp84) + (471960*y1)), ymask)
    ...
    tmp99 = tl.load(in_ptr1 + (y0 + (3*tmp98) + (1368*tmp97) + (471960*y1)), ymask)
    ...
    tmp107 = tl.load(in_ptr1 + (y0 + (3*tmp106) + (1368*tmp105) + (471960*y1)), ymask)
    ...
    tmp115 = tl.load(in_ptr1 + (y0 + (3*tmp114) + (1368*tmp113) + (471960*y1)), ymask)
    ...
    tmp128 = tl.load(in_ptr1 + (y0 + (3*tmp127) + (1368*tmp126) + (471960*y1)), ymask)
    ...
    tmp136 = tl.load(in_ptr1 + (y0 + (3*tmp135) + (1368*tmp134) + (471960*y1)), ymask)
    ...
    tmp144 = tl.load(in_ptr1 + (y0 + (3*tmp143) + (1368*tmp142) + (471960*y1)), ymask)
    ...
    tmp194 = tl.load(in_ptr1 + (y0 + (3*tmp193) + (1368*tmp191) + (471960*y1)), ymask)
    ...
    tmp208 = tl.load(in_ptr1 + (y0 + (3*tmp207) + (1368*tmp206) + (471960*y1)), ymask)
    ...
    tmp217 = tl.load(in_ptr1 + (y0 + (3*tmp216) + (1368*tmp215) + (471960*y1)), ymask)
    ...
    tmp226 = tl.load(in_ptr1 + (y0 + (3*tmp225) + (1368*tmp224) + (471960*y1)), ymask)
    ...
    tl.store(out_ptr24 + (y0 + (3*x2) + (471960*y1)), tmp275, xmask & ymask)
''')
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg2_1
        buf62 = empty_strided((s0, 3, 345, 456), (471960, 1, 1368, 3), device='cuda', dtype=torch.float32)
        # Source Nodes: [grid_sample], Original ATen: [aten.grid_sampler_2d]
        triton_poi_fused_grid_sampler_2d_1_ynumel = 3*s0
        triton_poi_fused_grid_sampler_2d_1.run(buf1, arg1_1, buf62, triton_poi_fused_grid_sampler_2d_1_ynumel, 157320, grid=grid(triton_poi_fused_grid_sampler_2d_1_ynumel, 157320), stream=stream0)
        del arg1_1
        return (buf62, )
