...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1):
        ...
        view_3 = torch.ops.aten.view.default(sum_1, [1, 345, 456, 2]);  sum_1 = None
        clone = torch.ops.aten.clone.default(arg0_1, memory_format = torch.contiguous_format);  arg0_1 = None
        view_4 = torch.ops.aten.view.default(view_3, [1, 1, 345, 456, 2]);  view_3 = None
        expand = torch.ops.aten.expand.default(view_4, [1, 3, 345, 456, 2]);  view_4 = None
        ...
        full_default_1 = torch.ops.aten.full.default([1, 1, 1, 1], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        where_2 = torch.ops.aten.where.self(logical_and_2, convert_element_type_4, full_default_2);  convert_element_type_4 = full_default_2 = None
        ...
        where_3 = torch.ops.aten.where.self(logical_and_2, convert_element_type_5, full_default_3);  convert_element_type_5 = full_default_3 = None
        ...
        full_default_5 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_4 = torch.ops.aten.where.self(logical_and_2, full_default_5, full_default_4);  logical_and_2 = full_default_5 = full_default_4 = None
        index = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_3, where_2]);  where_3 = where_2 = None
        ...
        where_5 = torch.ops.aten.where.self(logical_and_5, convert_element_type_6, full_default_6);  convert_element_type_6 = full_default_6 = None
        ...
        where_6 = torch.ops.aten.where.self(logical_and_5, convert_element_type_7, full_default_7);  convert_element_type_7 = full_default_7 = None
        ...
        full_default_9 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_7 = torch.ops.aten.where.self(logical_and_5, full_default_9, full_default_8);  logical_and_5 = full_default_9 = full_default_8 = None
        index_1 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_6, where_5]);  where_6 = where_5 = None
        ...
        where_8 = torch.ops.aten.where.self(logical_and_8, convert_element_type_8, full_default_10);  convert_element_type_8 = full_default_10 = None
        ...
        where_9 = torch.ops.aten.where.self(logical_and_8, convert_element_type_9, full_default_11);  convert_element_type_9 = full_default_11 = None
        full_default_12 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_13 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_10 = torch.ops.aten.where.self(logical_and_8, full_default_13, full_default_12);  logical_and_8 = full_default_13 = full_default_12 = None
        index_2 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_9, where_8]);  where_9 = where_8 = None
        ...
        where_11 = torch.ops.aten.where.self(logical_and_11, convert_element_type_10, full_default_14);  convert_element_type_10 = full_default_14 = None
        ...
        where_12 = torch.ops.aten.where.self(logical_and_11, convert_element_type_11, full_default_15);  convert_element_type_11 = full_default_15 = None
        full_default_16 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_17 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_13 = torch.ops.aten.where.self(logical_and_11, full_default_17, full_default_16);  logical_and_11 = full_default_17 = full_default_16 = None
        index_3 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_12, where_11]);  where_12 = where_11 = None
        ...
        where_14 = torch.ops.aten.where.self(logical_and_14, convert_element_type_12, full_default_18);  convert_element_type_12 = full_default_18 = None
        ...
        where_15 = torch.ops.aten.where.self(logical_and_14, convert_element_type_13, full_default_19);  convert_element_type_13 = full_default_19 = None
        full_default_20 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_21 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_16 = torch.ops.aten.where.self(logical_and_14, full_default_21, full_default_20);  logical_and_14 = full_default_21 = full_default_20 = None
        index_4 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_15, where_14]);  where_15 = where_14 = None
        ...
        where_17 = torch.ops.aten.where.self(logical_and_17, convert_element_type_14, full_default_22);  convert_element_type_14 = full_default_22 = None
        ...
        where_18 = torch.ops.aten.where.self(logical_and_17, convert_element_type_15, full_default_23);  convert_element_type_15 = full_default_23 = None
        full_default_24 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        where_19 = torch.ops.aten.where.self(logical_and_17, full_default_25, full_default_24);  logical_and_17 = full_default_25 = full_default_24 = None
        index_5 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_18, where_17]);  where_18 = where_17 = None
        ...
        where_20 = torch.ops.aten.where.self(logical_and_20, convert_element_type_16, full_default_26);  convert_element_type_16 = full_default_26 = None
        ...
        where_21 = torch.ops.aten.where.self(logical_and_20, convert_element_type_17, full_default_27);  convert_element_type_17 = full_default_27 = None
        full_default_28 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_29 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_22 = torch.ops.aten.where.self(logical_and_20, full_default_29, full_default_28);  logical_and_20 = full_default_29 = full_default_28 = None
        index_6 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_21, where_20]);  where_21 = where_20 = None
        ...
        where_23 = torch.ops.aten.where.self(logical_and_23, convert_element_type_18, full_default_30);  convert_element_type_18 = full_default_30 = None
        ...
        where_24 = torch.ops.aten.where.self(logical_and_23, convert_element_type_19, full_default_31);  convert_element_type_19 = full_default_31 = None
        full_default_32 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_33 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_25 = torch.ops.aten.where.self(logical_and_23, full_default_33, full_default_32);  logical_and_23 = full_default_33 = full_default_32 = None
        index_7 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_24, where_23]);  where_24 = where_23 = None
        ...
        where_26 = torch.ops.aten.where.self(logical_and_26, convert_element_type_20, full_default_34);  convert_element_type_20 = full_default_34 = None
        ...
        where_27 = torch.ops.aten.where.self(logical_and_26, convert_element_type_21, full_default_35);  convert_element_type_21 = full_default_35 = None
        full_default_36 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_37 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_28 = torch.ops.aten.where.self(logical_and_26, full_default_37, full_default_36);  logical_and_26 = full_default_37 = full_default_36 = None
        index_8 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_27, where_26]);  where_27 = where_26 = None
        ...
        where_29 = torch.ops.aten.where.self(logical_and_29, convert_element_type_22, full_default_38);  convert_element_type_22 = full_default_38 = None
        ...
        where_30 = torch.ops.aten.where.self(logical_and_29, convert_element_type_23, full_default_39);  convert_element_type_23 = full_default_39 = None
        full_default_40 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_41 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_31 = torch.ops.aten.where.self(logical_and_29, full_default_41, full_default_40);  logical_and_29 = full_default_41 = full_default_40 = None
        index_9 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_30, where_29]);  where_30 = where_29 = None
        ...
        where_32 = torch.ops.aten.where.self(logical_and_32, convert_element_type_24, full_default_42);  convert_element_type_24 = full_default_42 = None
        ...
        where_33 = torch.ops.aten.where.self(logical_and_32, convert_element_type_25, full_default_43);  convert_element_type_25 = full_default_43 = None
        full_default_44 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_45 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_34 = torch.ops.aten.where.self(logical_and_32, full_default_45, full_default_44);  logical_and_32 = full_default_45 = full_default_44 = None
        index_10 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_33, where_32]);  where_33 = where_32 = None
        ...
        where_35 = torch.ops.aten.where.self(logical_and_35, convert_element_type_26, full_default_46);  convert_element_type_26 = full_default_46 = None
        ...
        where_36 = torch.ops.aten.where.self(logical_and_35, convert_element_type_27, full_default_47);  convert_element_type_27 = full_default_47 = None
        full_default_48 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_49 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_37 = torch.ops.aten.where.self(logical_and_35, full_default_49, full_default_48);  logical_and_35 = full_default_49 = full_default_48 = None
        index_11 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_36, where_35]);  where_36 = where_35 = None
        ...
        where_38 = torch.ops.aten.where.self(logical_and_38, convert_element_type_28, full_default_50);  convert_element_type_28 = full_default_50 = None
        ...
        where_39 = torch.ops.aten.where.self(logical_and_38, convert_element_type_29, full_default_51);  convert_element_type_29 = full_default_51 = None
        full_default_52 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_53 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_40 = torch.ops.aten.where.self(logical_and_38, full_default_53, full_default_52);  logical_and_38 = full_default_53 = full_default_52 = None
        index_12 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_39, where_38]);  where_39 = where_38 = None
        ...
        where_41 = torch.ops.aten.where.self(logical_and_41, convert_element_type_30, full_default_54);  convert_element_type_30 = full_default_54 = None
        ...
        where_42 = torch.ops.aten.where.self(logical_and_41, convert_element_type_31, full_default_55);  convert_element_type_31 = full_default_55 = None
        full_default_56 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_57 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_43 = torch.ops.aten.where.self(logical_and_41, full_default_57, full_default_56);  logical_and_41 = full_default_57 = full_default_56 = None
        index_13 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_42, where_41]);  where_42 = where_41 = None
        ...
        where_44 = torch.ops.aten.where.self(logical_and_44, convert_element_type_32, full_default_58);  convert_element_type_32 = full_default_58 = None
        ...
        where_45 = torch.ops.aten.where.self(logical_and_44, convert_element_type_33, full_default_59);  convert_element_type_33 = full_default_59 = None
        full_default_60 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_61 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_46 = torch.ops.aten.where.self(logical_and_44, full_default_61, full_default_60);  logical_and_44 = full_default_61 = full_default_60 = None
        index_14 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_45, where_44]);  where_45 = where_44 = None
        ...
        where_47 = torch.ops.aten.where.self(logical_and_47, convert_element_type_34, full_default_62);  convert_element_type_34 = full_default_62 = None
        ...
        where_48 = torch.ops.aten.where.self(logical_and_47, convert_element_type_35, full_default_63);  convert_element_type_35 = full_default_63 = None
        full_default_64 = torch.ops.aten.full.default([], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        full_default_65 = torch.ops.aten.full.default([], 1, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        where_49 = torch.ops.aten.where.self(logical_and_47, full_default_65, full_default_64);  logical_and_47 = full_default_65 = full_default_64 = None
        index_15 = torch.ops.aten.index.Tensor(clone, [full_default_1, view_6, where_48, where_47]);  clone = full_default_1 = view_6 = where_48 = where_47 = None
        ...
        clone_1 = torch.ops.aten.clone.default(add_57, memory_format = torch.channels_last);  add_57 = None
        return (clone_1,)
        
def load_args(reader):
    buf0 = reader.storage(None, 1887840, device=device(type='cuda', index=0))
    reader.tensor(buf0, (1, 3, 345, 456), (471960, 1, 1368, 3), is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 24, device=device(type='cuda', index=0))
