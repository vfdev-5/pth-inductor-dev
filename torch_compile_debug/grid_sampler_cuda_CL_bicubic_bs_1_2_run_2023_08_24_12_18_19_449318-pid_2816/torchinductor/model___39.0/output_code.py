...
# kernel path: /tmp/torchinductor_root/fn/cfnfzrbvxx4a72xwktptrb4zxo7l4zy2xguzifsruptjekw6n4ta.py
...
@pointwise(size_hints=[524288], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
...
@pointwise(size_hints=[4, 262144], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr31, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 3
    xnumel = 157320
    ...
    tmp12 = tl.load(in_ptr0 + (1 + (2*x1)), xmask, eviction_policy='evict_last')
    tmp1 = 228.0
    tmp2 = tmp0 * tmp1
    tmp3 = 227.5
    tmp4 = tmp2 + tmp3
    ...
    tmp31 = tl.load(in_ptr1 + (y0 + (3*tmp30) + (1368*tmp28)), ymask)
    ...
    tmp44 = tl.load(in_ptr1 + (y0 + (3*tmp43) + (1368*tmp41)), ymask)
    ...
    tmp57 = tl.load(in_ptr1 + (y0 + (3*tmp56) + (1368*tmp54)), ymask)
    ...
    tmp70 = tl.load(in_ptr1 + (y0 + (3*tmp69) + (1368*tmp68)), ymask)
    ...
    tmp78 = tl.load(in_ptr1 + (y0 + (3*tmp77) + (1368*tmp76)), ymask)
    ...
    tmp86 = tl.load(in_ptr1 + (y0 + (3*tmp85) + (1368*tmp84)), ymask)
    ...
    tmp99 = tl.load(in_ptr1 + (y0 + (3*tmp98) + (1368*tmp97)), ymask)
    ...
    tmp107 = tl.load(in_ptr1 + (y0 + (3*tmp106) + (1368*tmp105)), ymask)
    ...
    tmp115 = tl.load(in_ptr1 + (y0 + (3*tmp114) + (1368*tmp113)), ymask)
    ...
    tmp128 = tl.load(in_ptr1 + (y0 + (3*tmp127) + (1368*tmp126)), ymask)
    ...
    tmp136 = tl.load(in_ptr1 + (y0 + (3*tmp135) + (1368*tmp134)), ymask)
    ...
    tmp144 = tl.load(in_ptr1 + (y0 + (3*tmp143) + (1368*tmp142)), ymask)
    ...
    tmp152 = tl.where(tmp151, tmp26, tmp27)
    tl.device_assert((0 <= tmp152) & (tmp152 < 345), "index out of bounds: 0 <= tmp152 < 345")
    tmp153 = tmp5.to(tl.int64)
    tmp154 = tl.where(tmp151, tmp153, tmp27)
    tl.device_assert((0 <= tmp154) & (tmp154 < 456), "index out of bounds: 0 <= tmp154 < 456")
    tmp155 = tl.load(in_ptr1 + (y0 + (3*tmp154) + (1368*tmp152)), ymask)
    tmp156 = tl.where(tmp151, tmp32, tmp27)
    ...
    tmp164 = tmp163 * tmp159
    tmp165 = tmp164 * tmp159
    tmp166 = tmp165 + tmp6
    tmp167 = tmp158 * tmp166
    tmp168 = tmp149 & tmp64
    tmp169 = tmp148 & tmp168
    tmp170 = tl.where(tmp169, tmp67, tmp27)
    tl.device_assert((0 <= tmp170) & (tmp170 < 345), "index out of bounds: 0 <= tmp170 < 345")
    tmp171 = tl.where(tmp169, tmp153, tmp27)
    tl.device_assert((0 <= tmp171) & (tmp171 < 456), "index out of bounds: 0 <= tmp171 < 456")
    tmp172 = tl.load(in_ptr1 + (y0 + (3*tmp171) + (1368*tmp170)), ymask)
    tmp173 = tl.where(tmp169, tmp32, tmp27)
    tmp174 = tmp173.to(tl.float32)
    tmp175 = tmp172 * tmp174
    tmp176 = tmp175 * tmp166
    tmp177 = tmp149 & tmp93
    tmp178 = tmp148 & tmp177
    tmp179 = tl.where(tmp178, tmp96, tmp27)
    tl.device_assert((0 <= tmp179) & (tmp179 < 345), "index out of bounds: 0 <= tmp179 < 345")
    tmp180 = tl.where(tmp178, tmp153, tmp27)
    tl.device_assert((0 <= tmp180) & (tmp180 < 456), "index out of bounds: 0 <= tmp180 < 456")
    tmp181 = tl.load(in_ptr1 + (y0 + (3*tmp180) + (1368*tmp179)), ymask)
    tmp182 = tl.where(tmp178, tmp32, tmp27)
    tmp183 = tmp182.to(tl.float32)
    tmp184 = tmp181 * tmp183
    tmp185 = tmp184 * tmp166
    tmp186 = tmp149 & tmp122
    tmp187 = tmp148 & tmp186
    tmp188 = tl.where(tmp187, tmp125, tmp27)
    tl.device_assert((0 <= tmp188) & (tmp188 < 345), "index out of bounds: 0 <= tmp188 < 345")
    tmp189 = tl.where(tmp187, tmp153, tmp27)
    tl.device_assert((0 <= tmp189) & (tmp189 < 456), "index out of bounds: 0 <= tmp189 < 456")
    tmp190 = tl.load(in_ptr1 + (y0 + (3*tmp189) + (1368*tmp188)), ymask)
    tmp191 = tl.where(tmp187, tmp32, tmp27)
    tmp192 = tmp191.to(tl.float32)
    tmp193 = tmp190 * tmp192
    tmp194 = tmp193 * tmp166
    tmp195 = tmp159 + tmp6
    tmp196 = -0.75
    tmp197 = tmp195 * tmp196
    tmp198 = -3.75
    tmp199 = tmp197 - tmp198
    tmp200 = tmp199 * tmp195
    tmp201 = -6.0
    tmp202 = tmp200 + tmp201
    tmp203 = tmp202 * tmp195
    tmp204 = -3.0
    tmp205 = tmp203 - tmp204
    tmp206 = tmp35 * tmp205
    tmp207 = tmp206 + tmp167
    tmp208 = tmp73 * tmp205
    tmp209 = tmp208 + tmp176
    tmp210 = tmp102 * tmp205
    tmp211 = tmp210 + tmp185
    tmp212 = tmp131 * tmp205
    tmp213 = tmp212 + tmp194
    tmp214 = tmp6 - tmp159
    tmp215 = tmp214 * tmp160
    tmp216 = tmp215 - tmp162
    tmp217 = tmp216 * tmp214
    tmp218 = tmp217 * tmp214
    tmp219 = tmp218 + tmp6
    tmp220 = tmp47 * tmp219
    tmp221 = tmp207 + tmp220
    tmp222 = tmp48 - tmp159
    tmp223 = tmp222 * tmp196
    tmp224 = tmp223 - tmp198
    tmp225 = tmp224 * tmp222
    tmp226 = tmp225 + tmp201
    tmp227 = tmp226 * tmp222
    tmp228 = tmp227 - tmp204
    tmp229 = tmp60 * tmp228
    tmp230 = tmp221 + tmp229
    tmp231 = tmp81 * tmp219
    tmp232 = tmp209 + tmp231
    tmp233 = tmp89 * tmp228
    tmp234 = tmp232 + tmp233
    tmp235 = tmp110 * tmp219
    tmp236 = tmp211 + tmp235
    tmp237 = tmp118 * tmp228
    tmp238 = tmp236 + tmp237
    tmp239 = tmp139 * tmp219
    tmp240 = tmp213 + tmp239
    tmp241 = tmp147 * tmp228
    tmp242 = tmp240 + tmp241
    tmp243 = tmp16 - tmp17
    tmp244 = tmp243 + tmp6
    tmp245 = tmp244 * tmp196
    tmp246 = tmp245 - tmp198
    tmp247 = tmp246 * tmp244
    tmp248 = tmp247 + tmp201
    tmp249 = tmp248 * tmp244
    tmp250 = tmp249 - tmp204
    tmp251 = tmp230 * tmp250
    tmp252 = tmp243 * tmp160
    tmp253 = tmp252 - tmp162
    tmp254 = tmp253 * tmp243
    tmp255 = tmp254 * tmp243
    tmp256 = tmp255 + tmp6
    tmp257 = tmp234 * tmp256
    tmp258 = tmp251 + tmp257
    tmp259 = tmp6 - tmp243
    tmp260 = tmp259 * tmp160
    tmp261 = tmp260 - tmp162
    tmp262 = tmp261 * tmp259
    tmp263 = tmp262 * tmp259
    tmp264 = tmp263 + tmp6
    tmp265 = tmp238 * tmp264
    tmp266 = tmp258 + tmp265
    tmp267 = tmp48 - tmp243
    tmp268 = tmp267 * tmp196
    tmp269 = tmp268 - tmp198
    tmp270 = tmp269 * tmp267
    tmp271 = tmp270 + tmp201
    tmp272 = tmp271 * tmp267
    tmp273 = tmp272 - tmp204
    tmp274 = tmp242 * tmp273
    tmp275 = tmp266 + tmp274
    tl.store(out_ptr31 + (y0 + (3*x1)), tmp275, xmask & ymask)
''')
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg1_1
        buf61 = empty_strided((1, 3, 345, 456), (471960, 1, 1368, 3), device='cuda', dtype=torch.float32)
        # Source Nodes: [grid_sample], Original ATen: [aten.grid_sampler_2d]
        triton_poi_fused_grid_sampler_2d_1.run(buf1, arg0_1, buf61, 3, 157320, grid=grid(3, 157320), stream=stream0)
        del arg0_1
        return (buf61, )
