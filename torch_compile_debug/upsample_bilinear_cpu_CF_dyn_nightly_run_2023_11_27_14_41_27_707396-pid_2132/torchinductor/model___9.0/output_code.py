        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks2); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks3); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp15 = decltype(tmp14)(tmp14 + tmp2);
                    auto tmp16 = c10::convert<float>(ks5*(1.0/ks3));
                    ...
                    auto tmp21 = in_ptr0[static_cast<long>(tmp20 + (ks5*tmp12) + (ks4*ks5*x0))];
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks2); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks3); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp18 = c10::convert<float>((-1L) + ks5);
                    auto tmp19 = min_propagate_nan(tmp17, tmp18);
                    auto tmp20 = c10::convert<long>(tmp19);
                    auto tmp21 = in_ptr0[static_cast<long>(tmp20 + (ks5*tmp9) + (ks4*ks5*x0))];
                    auto tmp22 = c10::convert<float>(tmp21);
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks2); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(ks3); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp21 = c10::convert<float>((-1L) + ks5);
                    auto tmp22 = min_propagate_nan(tmp20, tmp21);
                    auto tmp23 = c10::convert<long>(tmp22);
                    auto tmp24 = in_ptr0[static_cast<long>(tmp23 + (ks5*tmp12) + (ks4*ks5*x0))];
                    ...
                    out_ptr3[static_cast<long>(x2 + (ks3*x1) + (ks2*ks3*x0))] = tmp29;
                }
            }
        }
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0*ks1*ks2); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(ks3); x1+=static_cast<long>(1L))
            {
                ...
                auto tmp7 = c10::convert<float>(ks5*(1.0/ks3));
...
def call(args):
    ...
    buf0 = empty_strided((s0, s1, s4, s5), (s4*s5*s1, s4*s5, s5, 1), device='cpu', dtype=torch.float32)
    buf1 = empty_strided((s0, s1, s4, s5), (s4*s5*s1, s4*s5, s5, 1), device='cpu', dtype=torch.float32)
    buf2 = empty_strided((s0, s1, s4, s5), (s4*s5*s1, s4*s5, s5, 1), device='cpu', dtype=torch.float32)
    buf3 = empty_strided((s0, s1, s4, s5), (s4*s5*s1, s4*s5, s5, 1), device='cpu', dtype=torch.float32)
    buf4 = buf0; del buf0  # reuse
    buf5 = empty_strided((s0, s1, s4, s5), (s4*s5*s1, s4*s5, s5, 1), device='cpu', dtype=torch.uint8)
    cpp_fused__to_copy__unsafe_index_add_arange_clamp_mul_rsub_sub_0(c_void_p(buf4.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf5.data_ptr()), c_long(s0), c_long(s1), c_long(s4), c_long(s5), c_long(s2), c_long(s3))
    del arg4_1
    return (buf5, )
