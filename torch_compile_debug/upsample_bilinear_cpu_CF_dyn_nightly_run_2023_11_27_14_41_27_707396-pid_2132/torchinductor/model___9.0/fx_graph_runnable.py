...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1):
        ...
        truediv_2 = arg2_1 / arg5_1;  arg5_1 = None
        ...
        truediv_3 = arg3_1 / arg6_1;  arg6_1 = None
        ...
        _unsafe_index = torch.ops.aten._unsafe_index.Tensor(arg4_1, [None, None, unsqueeze_1, convert_element_type_2])
        _unsafe_index_1 = torch.ops.aten._unsafe_index.Tensor(arg4_1, [None, None, unsqueeze_2, convert_element_type_2])
        _unsafe_index_2 = torch.ops.aten._unsafe_index.Tensor(arg4_1, [None, None, unsqueeze_1, convert_element_type_3])
        _unsafe_index_3 = torch.ops.aten._unsafe_index.Tensor(arg4_1, [None, None, unsqueeze_2, convert_element_type_3]);  arg4_1 = unsqueeze_2 = convert_element_type_3 = None
...
def load_args(reader):
    ...
    reader.symint(400)  # arg3_1
    buf0 = reader.storage(None, s0*s1*s2*s3, dtype_hint=torch.uint8)
    reader.tensor(buf0, (s0, s1, s2, s3), dtype=torch.uint8, is_leaf=True)  # arg4_1
    reader.symint(256)  # arg5_1
    reader.symint(256)  # arg6_1
