...
# kernel path: /tmp/torchinductor_root/yi/cyi4o7m76kl64d2eeqcf3p3dadj45myqjphi67zevqozb37gxg6s.py
...
def triton_(in_out_ptr8, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp33 = tl.load(in_ptr1 + (tmp30 + (456*tmp28) + (157320*x1)), xmask)
    ...
    tmp48 = tl.load(in_ptr1 + (tmp45 + (456*tmp43) + (157320*x1)), xmask)
    ...
    tmp63 = tl.load(in_ptr1 + (tmp60 + (456*tmp58) + (157320*x1)), xmask)
    ...
    tmp78 = tl.load(in_ptr1 + (tmp75 + (456*tmp74) + (157320*x1)), xmask)
    ...
    tmp88 = tl.load(in_ptr1 + (tmp85 + (456*tmp84) + (157320*x1)), xmask)
    ...
    tmp98 = tl.load(in_ptr1 + (tmp95 + (456*tmp94) + (157320*x1)), xmask)
    ...
    tmp113 = tl.load(in_ptr1 + (tmp110 + (456*tmp109) + (157320*x1)), xmask)
    ...
    tmp123 = tl.load(in_ptr1 + (tmp120 + (456*tmp119) + (157320*x1)), xmask)
    ...
    tmp133 = tl.load(in_ptr1 + (tmp130 + (456*tmp129) + (157320*x1)), xmask)
    ...
    tmp148 = tl.load(in_ptr1 + (tmp145 + (456*tmp144) + (157320*x1)), xmask)
    ...
    tmp158 = tl.load(in_ptr1 + (tmp155 + (456*tmp154) + (157320*x1)), xmask)
    ...
    tmp168 = tl.load(in_ptr1 + (tmp165 + (456*tmp164) + (157320*x1)), xmask)
    ...
    tmp181 = tl.load(in_ptr1 + (tmp179 + (456*tmp176) + (157320*x1)), xmask)
    ...
    tmp200 = tl.load(in_ptr1 + (tmp198 + (456*tmp196) + (157320*x1)), xmask)
    ...
    tmp211 = tl.load(in_ptr1 + (tmp209 + (456*tmp207) + (157320*x1)), xmask)
    ...
    tmp222 = tl.load(in_ptr1 + (tmp220 + (456*tmp218) + (157320*x1)), xmask)
