...
cpp_fused__to_copy_add_div_index_mul_round_sum_unbind_0 = async_compile.cpp('''
                       ...
                       const long ks0)
{
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(ks0); x0+=static_cast<long>(1L))
        {
            ...
            {
                #pragma GCC ivdep
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(345L); x2+=static_cast<long>(1L))
                {
                    #pragma GCC ivdep
                    for(long x3=static_cast<long>(0L); x3<static_cast<long>(270L); x3+=static_cast<long>(1L))
                    {
                        auto tmp16 = out_ptr2[static_cast<long>(x3)];
                        auto tmp23 = out_ptr2[static_cast<long>(270L + x3)];
                        auto tmp31 = out_ptr2[static_cast<long>(540L + x3)];
                        auto tmp39 = out_ptr2[static_cast<long>(810L + x3)];
                        auto tmp0 = static_cast<long>(x3);
                        auto tmp1 = static_cast<float>(tmp0);
                        auto tmp2 = static_cast<float>(0.5);
                        auto tmp3 = tmp1 + tmp2;
                        auto tmp4 = static_cast<float>(1.6888888888888889);
                        ...
                        auto tmp14 = in_ptr0[static_cast<long>(x1 + (3L*tmp13) + (1368L*x2) + (471960L*x0))];
                        ...
                        auto tmp21 = in_ptr0[static_cast<long>(x1 + (3L*tmp20) + (1368L*x2) + (471960L*x0))];
                        auto tmp22 = static_cast<float>(tmp21);
                        ...
                        auto tmp29 = in_ptr0[static_cast<long>(x1 + (3L*tmp28) + (1368L*x2) + (471960L*x0))];
                        ...
                        auto tmp37 = in_ptr0[static_cast<long>(x1 + (3L*tmp36) + (1368L*x2) + (471960L*x0))];
                        auto tmp38 = static_cast<float>(tmp37);
                        auto tmp40 = decltype(tmp38)(tmp38 * tmp39);
                        auto tmp41 = tmp33 + tmp40;
                        in_out_ptr0[static_cast<long>(x3 + (270L*x2) + (93150L*x1) + (279450L*x0))] = tmp41;
                    }
                }
            }
        }
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(3L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(270L); x2+=static_cast<long>(1L))
                {
                    ...
                    for(long x3=static_cast<long>(0L); x3<static_cast<long>(270L); x3+=static_cast<long>(1L))
                    {
                        ...
                        auto tmp13 = min_propagate_nan(tmp11, tmp12);
                        auto tmp14 = in_out_ptr0[static_cast<long>(x3 + (270L*tmp13) + (93150L*x1) + (279450L*x0))];
                        auto tmp15 = static_cast<long>(x3);
                        ...
                        auto tmp28 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp13) + (471960L*x0))];
                        ...
                        auto tmp36 = in_out_ptr0[static_cast<long>(x3 + (270L*tmp35) + (93150L*x1) + (279450L*x0))];
                        auto tmp37 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp35) + (471960L*x0))];
                        auto tmp38 = static_cast<float>(tmp37);
                        ...
                        auto tmp44 = in_out_ptr0[static_cast<long>(x3 + (270L*tmp43) + (93150L*x1) + (279450L*x0))];
                        auto tmp45 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp43) + (471960L*x0))];
                        ...
                        auto tmp52 = in_out_ptr0[static_cast<long>(x3 + (270L*tmp51) + (93150L*x1) + (279450L*x0))];
                        auto tmp53 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp51) + (471960L*x0))];
                        ...
                        auto tmp59 = in_out_ptr0[static_cast<long>(x3 + (270L*tmp58) + (93150L*x1) + (279450L*x0))];
                        auto tmp60 = in_ptr0[static_cast<long>(x1 + (3L*tmp27) + (1368L*tmp58) + (471960L*x0))];
                        auto tmp61 = static_cast<float>(tmp60);
                        auto tmp62 = decltype(tmp61)(tmp61 * tmp30);
                        auto tmp63 = tmp59 + tmp62;
                        out_ptr4[static_cast<long>(x3 + (270L*x2) + (72900L*x1) + (218700L*x0))] = tmp32;
                        out_ptr5[static_cast<long>(x3 + (270L*x2) + (72900L*x1) + (218700L*x0))] = tmp40;
                        out_ptr6[static_cast<long>(x3 + (270L*x2) + (72900L*x1) + (218700L*x0))] = tmp48;
                        out_ptr7[static_cast<long>(x3 + (270L*x2) + (72900L*x1) + (218700L*x0))] = tmp56;
                        out_ptr8[static_cast<long>(x3 + (270L*x2) + (72900L*x1) + (218700L*x0))] = tmp63;
                    }
                }
            }
        }
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(5L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(270L); x1+=static_cast<long>(1L))
            {
                ...
                auto tmp32 = tmp20 ? tmp30 : tmp31;
                auto tmp34 = tmp32 / tmp33;
                out_ptr9[static_cast<long>(x1 + (270L*x0))] = tmp34;
            }
        }
    }
    {
        #pragma GCC ivdep
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(3L*ks0); x0+=static_cast<long>(1L))
        {
            #pragma GCC ivdep
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(270L); x1+=static_cast<long>(1L))
            {
                ...
                {
                    auto tmp0 = at::vec::Vectorized<float>::loadu(out_ptr4 + static_cast<long>(x2 + (270L*x1) + (72900L*x0)));
                    auto tmp1 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(x1)]));
                    auto tmp3 = at::vec::Vectorized<float>::loadu(out_ptr5 + static_cast<long>(x2 + (270L*x1) + (72900L*x0)));
                    auto tmp4 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(270L + x1)]));
                    auto tmp7 = at::vec::Vectorized<float>::loadu(out_ptr6 + static_cast<long>(x2 + (270L*x1) + (72900L*x0)));
                    auto tmp8 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(540L + x1)]));
                    auto tmp11 = at::vec::Vectorized<float>::loadu(out_ptr7 + static_cast<long>(x2 + (270L*x1) + (72900L*x0)));
                    auto tmp12 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(810L + x1)]));
                    auto tmp15 = at::vec::Vectorized<float>::loadu(out_ptr8 + static_cast<long>(x2 + (270L*x1) + (72900L*x0)));
                    auto tmp16 = at::vec::Vectorized<float>(static_cast<float>(out_ptr9[static_cast<long>(1080L + x1)]));
                    auto tmp2 = tmp0 * tmp1;
                    auto tmp5 = tmp3 * tmp4;
                    auto tmp6 = tmp2 + tmp5;
                    auto tmp9 = tmp7 * tmp8;
                    ...
                    tmp18.store(in_out_ptr1 + static_cast<long>(x2 + (270L*x1) + (72900L*x0)));
                }
                #pragma omp simd simdlen(4) 
                for(long x2=static_cast<long>(264L); x2<static_cast<long>(270L); x2+=static_cast<long>(1L))
                {
                    auto tmp0 = out_ptr4[static_cast<long>(x2 + (270L*x1) + (72900L*x0))];
                    auto tmp1 = out_ptr9[static_cast<long>(x1)];
                    auto tmp3 = out_ptr5[static_cast<long>(x2 + (270L*x1) + (72900L*x0))];
                    auto tmp4 = out_ptr9[static_cast<long>(270L + x1)];
                    auto tmp7 = out_ptr6[static_cast<long>(x2 + (270L*x1) + (72900L*x0))];
                    auto tmp8 = out_ptr9[static_cast<long>(540L + x1)];
                    auto tmp11 = out_ptr7[static_cast<long>(x2 + (270L*x1) + (72900L*x0))];
                    auto tmp12 = out_ptr9[static_cast<long>(810L + x1)];
                    auto tmp15 = out_ptr8[static_cast<long>(x2 + (270L*x1) + (72900L*x0))];
                    auto tmp16 = out_ptr9[static_cast<long>(1080L + x1)];
                    ...
                    auto tmp17 = decltype(tmp15)(tmp15 * tmp16);
                    auto tmp18 = tmp14 + tmp17;
                    in_out_ptr1[static_cast<long>(x2 + (270L*x1) + (72900L*x0))] = tmp18;
                }
            }
        }
    }
    {
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(8L*(at::native::div_floor_integer((54675L*ks0), 2L))); x0+=static_cast<long>(8L))
        {
            auto tmp0 = at::vec::Vectorized<float>::loadu(in_out_ptr1 + static_cast<long>(x0));
            auto tmp1 = tmp0.round();
            auto tmp2 = at::vec::convert_float_to_uint8(tmp1);
            tmp2.store(out_ptr10 + static_cast<long>(x0), 8);
        }
        #pragma omp simd simdlen(4) 
        for(long x0=static_cast<long>(8L*(at::native::div_floor_integer((54675L*ks0), 2L))); x0<static_cast<long>(218700L*ks0); x0+=static_cast<long>(1L))
        {
...
def call(args):
    ...
    buf5 = empty_strided((s0, 3, 345, 270), (279450, 93150, 270, 1), device='cpu', dtype=torch.float32)
    buf6 = buf5; del buf5  # reuse
    buf7 = empty_strided((s0, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf9 = empty_strided((s0, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf10 = empty_strided((s0, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf11 = empty_strided((s0, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf12 = empty_strided((s0, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.float32)
    buf8 = empty_strided((5, 270), (270, 1), device='cpu', dtype=torch.float32)
    buf13 = buf10; del buf10  # reuse
    buf14 = empty_strided((s0, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.uint8)
    cpp_fused__to_copy_add_div_index_mul_round_sum_unbind_0(c_void_p(buf6.data_ptr()), c_void_p(buf13.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf7.data_ptr()), c_void_p(buf9.data_ptr()), c_void_p(buf11.data_ptr()), c_void_p(buf12.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf14.data_ptr()), c_long(s0))
    del arg1_1
    return (buf14, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 4
    arg1_1 = rand_strided((4, 3, 345, 456), (471960, 1, 1368, 3), device='cpu', dtype=torch.uint8)
