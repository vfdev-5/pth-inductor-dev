                       ...
                       const long ks0)
{
    ...
    {
        #pragma GCC ivdep
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(1035L*ks0); x0+=static_cast<long>(1L))
        {
            #pragma GCC ivdep
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(270L); x1+=static_cast<long>(1L))
            {
                auto tmp16 = out_ptr2[static_cast<long>(x1)];
                auto tmp23 = out_ptr2[static_cast<long>(270L + x1)];
                auto tmp31 = out_ptr2[static_cast<long>(540L + x1)];
                auto tmp39 = out_ptr2[static_cast<long>(810L + x1)];
                auto tmp0 = static_cast<long>(x1);
                auto tmp1 = static_cast<float>(tmp0);
                auto tmp2 = static_cast<float>(0.5);
                auto tmp3 = tmp1 + tmp2;
                ...
                auto tmp14 = in_ptr0[static_cast<long>(tmp13 + (456L*x0))];
                ...
                auto tmp29 = in_ptr0[static_cast<long>(tmp28 + (456L*x0))];
                ...
                auto tmp37 = in_ptr0[static_cast<long>(tmp36 + (456L*x0))];
                auto tmp38 = static_cast<float>(tmp37);
                auto tmp40 = decltype(tmp38)(tmp38 * tmp39);
                auto tmp41 = tmp33 + tmp40;
                in_out_ptr0[static_cast<long>(x1 + (270L*x0))] = tmp41;
            }
        }
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(3L*ks0); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(270L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(270L); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp28 = in_ptr0[static_cast<long>(tmp27 + (456L*tmp13) + (157320L*x0))];
                    ...
                    auto tmp37 = in_ptr0[static_cast<long>(tmp27 + (456L*tmp35) + (157320L*x0))];
                    auto tmp38 = static_cast<float>(tmp37);
                    ...
                    auto tmp45 = in_ptr0[static_cast<long>(tmp27 + (456L*tmp43) + (157320L*x0))];
                    ...
                    auto tmp53 = in_ptr0[static_cast<long>(tmp27 + (456L*tmp51) + (157320L*x0))];
                    ...
                    auto tmp60 = in_ptr0[static_cast<long>(tmp27 + (456L*tmp58) + (157320L*x0))];
...
def call(args):
    ...
    args.clear()
    s0 = arg0_1
    assert_size_stride(arg1_1, (s0, 3, 345, 456), (471960, 157320, 456, 1))
    ...
    cpp_fused__to_copy_add_div_index_mul_round_sum_unbind_0(c_void_p(buf6.data_ptr()), c_void_p(buf13.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf14.data_ptr()), c_long(s0))
    del arg1_1
    return (buf14, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 4
    arg1_1 = rand_strided((4, 3, 345, 456), (471960, 157320, 456, 1), device='cpu', dtype=torch.uint8)
