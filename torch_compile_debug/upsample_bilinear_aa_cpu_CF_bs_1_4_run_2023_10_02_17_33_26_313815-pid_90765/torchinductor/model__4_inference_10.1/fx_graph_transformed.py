class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: Sym(s0), arg1_1: u8[s0, 3, 345, 456]):
        ...
        add_21: i64[5, 270] = torch.ops.aten.add.Tensor(view_7, clamp_min_1);  view_7 = None
        ...
        view: i64[s0, 1, 1, 1] = torch.ops.aten.reshape.default(iota, [arg0_1, 1, 1, 1]);  iota = arg0_1 = None
        ...
        view_5: i64[s0, 1, 1, 1] = torch.ops.aten.reshape.default(iota_5, [floordiv, 1, 1, 1]);  iota_5 = floordiv = None
