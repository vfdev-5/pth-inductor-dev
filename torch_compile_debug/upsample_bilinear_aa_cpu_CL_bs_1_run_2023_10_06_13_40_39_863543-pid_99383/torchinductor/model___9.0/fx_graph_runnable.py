...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1):
        ...
        mul = torch.ops.aten.mul.Tensor(add, 1.6888888888888889);  add = None
        sub = torch.ops.aten.sub.Tensor(mul, 1.6888888888888889)
        ...
        add_2 = torch.ops.aten.add.Tensor(mul, 1.6888888888888889)
        ...
        mul_1 = torch.ops.aten.mul.Tensor(add_5, 0.5921052631578947);  add_5 = None
        ...
        mul_6 = torch.ops.aten.mul.Tensor(index_4, full_default_2);  index_4 = full_default_2 = None
        add_14 = torch.ops.aten.add.Tensor(add_13, mul_6);  add_13 = mul_6 = None
        iota_5 = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
        full_default_3 = torch.ops.aten.full.default([1, 1, 1, 1], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
        ...
        mul_7 = torch.ops.aten.mul.Tensor(add_15, 1.2777777777777777);  add_15 = None
        sub_4 = torch.ops.aten.sub.Tensor(mul_7, 1.2777777777777777)
        ...
        add_17 = torch.ops.aten.add.Tensor(mul_7, 1.2777777777777777)
        ...
        mul_8 = torch.ops.aten.mul.Tensor(add_20, 0.782608695652174);  add_20 = None
        ...
        index_5 = torch.ops.aten.index.Tensor(add_14, [full_default_3, view_6, clamp_max_11, view_8]);  clamp_max_11 = None
        add_22 = torch.ops.aten.add.Tensor(view_9, 1)
        clamp_max_12 = torch.ops.aten.clamp_max.default(add_22, 344);  add_22 = None
        index_6 = torch.ops.aten.index.Tensor(add_14, [full_default_3, view_6, clamp_max_12, view_8]);  clamp_max_12 = None
        add_23 = torch.ops.aten.add.Tensor(view_9, 2)
        clamp_max_13 = torch.ops.aten.clamp_max.default(add_23, 344);  add_23 = None
        index_7 = torch.ops.aten.index.Tensor(add_14, [full_default_3, view_6, clamp_max_13, view_8]);  clamp_max_13 = None
        add_24 = torch.ops.aten.add.Tensor(view_9, 3)
        clamp_max_14 = torch.ops.aten.clamp_max.default(add_24, 344);  add_24 = None
        index_8 = torch.ops.aten.index.Tensor(add_14, [full_default_3, view_6, clamp_max_14, view_8]);  clamp_max_14 = None
        ...
        index_9 = torch.ops.aten.index.Tensor(add_14, [full_default_3, view_6, clamp_max_15, view_8]);  add_14 = full_default_3 = view_6 = clamp_max_15 = view_8 = None
        ...
        round_1 = torch.ops.aten.round.default(add_29);  add_29 = None
        clone = torch.ops.aten.clone.default(round_1, memory_format = torch.channels_last);  round_1 = None
        convert_element_type_4 = torch.ops.prims.convert_element_type.default(clone, torch.uint8);  clone = None
        return (convert_element_type_4,)
        
def load_args(reader):
    buf0 = reader.storage(None, 471960, dtype_hint=torch.uint8)
    reader.tensor(buf0, (1, 3, 345, 456), (471960, 1, 1368, 3), dtype=torch.uint8, is_leaf=True)  # arg0_1
