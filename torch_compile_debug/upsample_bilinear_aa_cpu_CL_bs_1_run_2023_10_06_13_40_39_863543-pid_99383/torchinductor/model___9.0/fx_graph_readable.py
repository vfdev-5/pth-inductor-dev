class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: u8[1, 3, 345, 456]):
        ...
        clone: f32[1, 3, 270, 270] = torch.ops.aten.clone.default(round_1, memory_format = torch.channels_last);  round_1 = None
        convert_element_type_4: u8[1, 3, 270, 270] = torch.ops.prims.convert_element_type.default(clone, torch.uint8);  clone = None
