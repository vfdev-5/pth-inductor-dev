class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "Sym(s0)", arg1_1: "Sym(s1)", arg2_1: "Sym(s2)", arg3_1: "f32[1, s0, s1, s2]", arg4_1: "Sym(s3)", arg5_1: "Sym(s4)"):
        ...
        unsqueeze: "f32[s3, 1]" = torch.ops.aten.unsqueeze.default(mul_2, 1)
        sub_8: "f32[s3, 1]" = torch.ops.aten.sub.Tensor(unsqueeze, unsqueeze_1);  unsqueeze = None
        ...
        ceil_2: "f32[s3]" = torch.ops.aten.ceil.default(mul_2);  mul_2 = None
        ...
        sub_10: "f32[s4]" = torch.ops.aten.sub.Tensor(mul_3, convert_element_type_6);  convert_element_type_6 = None
        ...
        ceil_3: "f32[s4]" = torch.ops.aten.ceil.default(mul_3);  mul_3 = None
        ...
        _unsafe_index_2: "f32[1, s0, s3, s4]" = torch.ops.aten._unsafe_index.Tensor(arg3_1, [None, None, unsqueeze_1, convert_element_type_7]);  unsqueeze_1 = None
