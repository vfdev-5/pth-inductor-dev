...
# kernel path: /tmp/torchinductor_root/qz/cqzi6fgveivzsi25cwpgwxuifjzkxvqrp736fkrsk4pgaktlv3io.py
...
def triton_(in_out_ptr1, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp33 = tl.load(in_ptr1 + (tmp30 + (456*tmp28) + (157320*x4)), xmask)
    ...
    tmp48 = tl.load(in_ptr1 + (tmp45 + (456*tmp43) + (157320*x4)), xmask)
    ...
    tmp63 = tl.load(in_ptr1 + (tmp60 + (456*tmp58) + (157320*x4)), xmask)
    ...
    tmp78 = tl.load(in_ptr1 + (tmp75 + (456*tmp74) + (157320*x4)), xmask)
    ...
    tmp88 = tl.load(in_ptr1 + (tmp85 + (456*tmp84) + (157320*x4)), xmask)
    ...
    tmp98 = tl.load(in_ptr1 + (tmp95 + (456*tmp94) + (157320*x4)), xmask)
    ...
    tmp113 = tl.load(in_ptr1 + (tmp110 + (456*tmp109) + (157320*x4)), xmask)
    ...
    tmp123 = tl.load(in_ptr1 + (tmp120 + (456*tmp119) + (157320*x4)), xmask)
    ...
    tmp133 = tl.load(in_ptr1 + (tmp130 + (456*tmp129) + (157320*x4)), xmask)
    ...
    tmp148 = tl.load(in_ptr1 + (tmp145 + (456*tmp144) + (157320*x4)), xmask)
    ...
    tmp158 = tl.load(in_ptr1 + (tmp155 + (456*tmp154) + (157320*x4)), xmask)
    ...
    tmp168 = tl.load(in_ptr1 + (tmp165 + (456*tmp164) + (157320*x4)), xmask)
    ...
    tmp220 = tl.load(in_ptr1 + (tmp218 + (456*tmp215) + (157320*x4)), xmask)
    ...
    tmp236 = tl.load(in_ptr1 + (tmp234 + (456*tmp232) + (157320*x4)), xmask)
    ...
    tmp247 = tl.load(in_ptr1 + (tmp245 + (456*tmp243) + (157320*x4)), xmask)
    ...
    tmp258 = tl.load(in_ptr1 + (tmp256 + (456*tmp254) + (157320*x4)), xmask)
...
if __name__ == "__main__":
    ...
    results.append(
        benchmark.Timer(
            ...
            sub_label=f"bicubic f32, CF, BS={n}",
