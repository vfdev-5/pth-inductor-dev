class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: u8[4, 3, 345, 456]):
        ...
        iota: i64[4] = torch.ops.prims.iota.default(4, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
        view: i64[4, 1, 1, 1] = torch.ops.aten.view.default(iota, [4, 1, 1, 1]);  iota = None
        ...
        add_4: i64[5, 270] = torch.ops.aten.add.Tensor(view_2, clamp_min)
        ...
        where: f32[5, 270] = torch.ops.aten.where.self(lt, sub_3, full_default);  lt = sub_3 = full_default = None
        ...
        index: u8[4, 3, 345, 270] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_3]);  clamp_max_3 = None
        ...
        index_1: u8[4, 3, 345, 270] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_4]);  clamp_max_4 = None
        ...
        index_2: u8[4, 3, 345, 270] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_5]);  clamp_max_5 = None
        ...
        index_3: u8[4, 3, 345, 270] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_6]);  clamp_max_6 = None
        ...
        index_4: u8[4, 3, 345, 270] = torch.ops.aten.index.Tensor(arg0_1, [view, view_1, view_3, clamp_max_7]);  arg0_1 = view = view_1 = view_3 = clamp_max_7 = None
        ...
        mul_2: f32[4, 3, 345, 270] = torch.ops.aten.mul.Tensor(index, getitem);  index = getitem = None
        mul_3: f32[4, 3, 345, 270] = torch.ops.aten.mul.Tensor(index_1, getitem_1);  index_1 = getitem_1 = None
        add_11: f32[4, 3, 345, 270] = torch.ops.aten.add.Tensor(mul_2, mul_3);  mul_2 = mul_3 = None
        mul_4: f32[4, 3, 345, 270] = torch.ops.aten.mul.Tensor(index_2, getitem_2);  index_2 = getitem_2 = None
        add_12: f32[4, 3, 345, 270] = torch.ops.aten.add.Tensor(add_11, mul_4);  add_11 = mul_4 = None
        mul_5: f32[4, 3, 345, 270] = torch.ops.aten.mul.Tensor(index_3, getitem_3);  index_3 = getitem_3 = None
        add_13: f32[4, 3, 345, 270] = torch.ops.aten.add.Tensor(add_12, mul_5);  add_12 = mul_5 = None
        mul_6: f32[4, 3, 345, 270] = torch.ops.aten.mul.Tensor(index_4, full_default_1);  index_4 = full_default_1 = None
        add_14: f32[4, 3, 345, 270] = torch.ops.aten.add.Tensor(add_13, mul_6);  add_13 = mul_6 = None
        iota_5: i64[4] = torch.ops.prims.iota.default(4, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
        view_5: i64[4, 1, 1, 1] = torch.ops.aten.view.default(iota_5, [4, 1, 1, 1]);  iota_5 = None
        ...
        add_19: i64[5, 270] = torch.ops.aten.add.Tensor(view_7, clamp_min_1)
        ...
        where_1: f32[5, 270] = torch.ops.aten.where.self(lt_1, sub_7, full_default_2);  lt_1 = sub_7 = full_default_2 = None
        ...
        index_5: f32[4, 3, 270, 270] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_11, view_8]);  clamp_max_11 = None
        ...
        index_6: f32[4, 3, 270, 270] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_12, view_8]);  clamp_max_12 = None
        ...
        index_7: f32[4, 3, 270, 270] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_13, view_8]);  clamp_max_13 = None
        ...
        index_8: f32[4, 3, 270, 270] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_14, view_8]);  clamp_max_14 = None
        ...
        index_9: f32[4, 3, 270, 270] = torch.ops.aten.index.Tensor(add_14, [view_5, view_6, clamp_max_15, view_8]);  add_14 = view_5 = view_6 = clamp_max_15 = view_8 = None
        ...
        mul_9: f32[4, 3, 270, 270] = torch.ops.aten.mul.Tensor(index_5, getitem_5);  index_5 = getitem_5 = None
        mul_10: f32[4, 3, 270, 270] = torch.ops.aten.mul.Tensor(index_6, getitem_6);  index_6 = getitem_6 = None
        add_26: f32[4, 3, 270, 270] = torch.ops.aten.add.Tensor(mul_9, mul_10);  mul_9 = mul_10 = None
        mul_11: f32[4, 3, 270, 270] = torch.ops.aten.mul.Tensor(index_7, getitem_7);  index_7 = getitem_7 = None
        add_27: f32[4, 3, 270, 270] = torch.ops.aten.add.Tensor(add_26, mul_11);  add_26 = mul_11 = None
        mul_12: f32[4, 3, 270, 270] = torch.ops.aten.mul.Tensor(index_8, getitem_8);  index_8 = getitem_8 = None
        add_28: f32[4, 3, 270, 270] = torch.ops.aten.add.Tensor(add_27, mul_12);  add_27 = mul_12 = None
        mul_13: f32[4, 3, 270, 270] = torch.ops.aten.mul.Tensor(index_9, getitem_9);  index_9 = getitem_9 = None
        add_29: f32[4, 3, 270, 270] = torch.ops.aten.add.Tensor(add_28, mul_13);  add_28 = mul_13 = None
        round_1: f32[4, 3, 270, 270] = torch.ops.aten.round.default(add_29);  add_29 = None
        convert_element_type_4: u8[4, 3, 270, 270] = torch.ops.prims.convert_element_type.default(round_1, torch.uint8);  round_1 = None
