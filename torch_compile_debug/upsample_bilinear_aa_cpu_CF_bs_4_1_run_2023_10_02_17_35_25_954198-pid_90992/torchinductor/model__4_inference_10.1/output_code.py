                       ...
                       unsigned char* out_ptr10)
{
    ...
    {
        #pragma GCC ivdep
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(1035L); x0+=static_cast<long>(1L))
        {
            #pragma GCC ivdep
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(270L); x1+=static_cast<long>(1L))
            {
    ...
    {
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(218696L); x0+=static_cast<long>(8L))
        {
        ...
        for(long x0=static_cast<long>(218696L); x0<static_cast<long>(218700L); x0+=static_cast<long>(1L))
        {
...
def call(args):
    ...
    buf14 = empty_strided((1, 3, 270, 270), (218700, 72900, 270, 1), device='cpu', dtype=torch.uint8)
    cpp_fused__to_copy_add_div_index_mul_round_sum_unbind_0(c_void_p(buf6.data_ptr()), c_void_p(buf13.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf14.data_ptr()))
    del arg0_1
    return (buf14, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 3, 345, 456), (471960, 157320, 456, 1), device='cpu', dtype=torch.uint8)
