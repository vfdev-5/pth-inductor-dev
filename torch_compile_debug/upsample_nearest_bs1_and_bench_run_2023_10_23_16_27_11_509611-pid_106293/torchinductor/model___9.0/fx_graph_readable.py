class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: f32[1, 3, 500, 400]):
        ...
        _unsafe_index: f32[1, 3, 256, 256] = torch.ops.aten._unsafe_index.Tensor(arg0_1, [None, None, unsqueeze, convert_element_type_3]);  arg0_1 = unsqueeze = convert_element_type_3 = None
