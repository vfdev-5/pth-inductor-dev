...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty((4, 3, 256, 256), device='cuda', dtype=torch.float32)
        # Source Nodes: [img], Original ATen: [aten._unsafe_index]
        stream0 = get_cuda_stream(0)
        triton_poi_fused__unsafe_index_0.run(arg0_1, buf0, 3 * 256 * 256 * 4, grid=grid(3 * 256 * 256 * 4), stream=stream0)
        del arg0_1
        return (buf0, )
